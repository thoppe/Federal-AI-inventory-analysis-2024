## HHS-2024-0136
+ **Title of the AI use case:**: Document Digitization by AdobePro
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Adobe Pro can convert scanned documents into digital data.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The output is digital data with searchable functionality.
