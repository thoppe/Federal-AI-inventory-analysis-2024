## VA-2024-0006
+ **Title of the AI use case:**: GE Xeleris
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Xeleris V leverages AI to accurately segment organs for quantitation and dosimetry calculations. Q.Thera AI demonstrated an average reduction of 58% in the time required for the user to process and calculate dose3.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Provide patient dosimetry calculations.
