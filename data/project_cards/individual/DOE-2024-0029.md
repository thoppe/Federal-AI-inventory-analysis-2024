## DOE-2024-0029
+ **Title of the AI use case:**: Records Digitization
+ **Agency responsible for the AI use case:**: Department of Energy
+ **Agency abbreviation:**: DOE
+ **Specific organization(s) within the agency responsible for the AI use case:**: SEPA - Southeastern Power Administration (PMA)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: SEPA is leveraging AI and ML to enhance metadata tagging and quality control during the records digitization process.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Acurate metadata assignment in accordance with SEPA's NARA-approved file plan/records schedule.
