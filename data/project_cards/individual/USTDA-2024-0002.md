## USTDA-2024-0002
+ **Title of the AI use case:**: Qualys Cloud Detection and Response
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Qualys uses AI to detect threats in real time, such as malware, ransomware, and unauthorized access.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: A Dashboard used for monitoring activity and reports; real-time alerts when issues are discovered.
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 12/1/2021
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Qualys (FEDRAMP) PK ID F1508207205
