## FHFA-2024-0014
+ **Title of the AI use case:**: Workflow automation and predictive analytics using ServiceNow
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Help to automate workflows, predictive analytics, and providing intelligent service management solutions.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: ServiceNow utilizes AI for automating workflows, predictive analytics, and providing intelligent service management solutions.
