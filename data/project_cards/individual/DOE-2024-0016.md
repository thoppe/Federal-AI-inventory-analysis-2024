## DOE-2024-0016
+ **Title of the AI use case:**: Spot for automated sensing, inspection, and capture
+ **Agency responsible for the AI use case:**: Department of Energy
+ **Agency abbreviation:**: DOE
+ **Specific organization(s) within the agency responsible for the AI use case:**: PNNL - Pacific Northwest National Laboratory (SC43 OIM)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Spot, a mobile robot, can navigate hazardous or hard-to-reach areas to perform inspections and gather precise data with its advanced sensors and cameras.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Improving efficiency, and the accuracy of sensor research data.
