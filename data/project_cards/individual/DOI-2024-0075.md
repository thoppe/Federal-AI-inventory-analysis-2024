## DOI-2024-0075
+ **Title of the AI use case:**: Shoreline Modeling
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Exploring the prospect of using AI/ML models to predict shoreline change and compare accuracy to traditional models. Examples of AI/ML models include LSTM, CNN, and Transformers
