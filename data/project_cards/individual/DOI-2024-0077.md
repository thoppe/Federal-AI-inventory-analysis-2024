## DOI-2024-0077
+ **Title of the AI use case:**: Oceanographic, coastal, and geomorphic change analysis: data generation, QC/QA, and data management
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Deep Learning based image segmentation, time-series methods, classification & regression methods. Custom scripts/tools using python/pytorch/tensorflow/keras and other ML libraries and APIs
