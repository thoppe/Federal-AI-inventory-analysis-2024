## VA-2024-0014
+ **Title of the AI use case:**: Radiology - Siemens YSIO Max
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Bone supression: Supressess bones on digital images without the need for two exposures. Diamond View: improves image contrast and detail to improve image quality.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Increase radiology digital image quality.
