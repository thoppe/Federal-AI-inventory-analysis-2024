## SEC-2024-0002
+ **Title of the AI use case:**: Forms Filed
+ **Agency responsible for the AI use case:**: Securities and Exchange Commission
+ **Agency abbreviation:**: SEC
+ **Specific organization(s) within the agency responsible for the AI use case:**: Division of Investment Management (IM)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Assists staff in evaluating completeness of filed information at scale by automating the identification of failures to file certain forms utilized by investment companies.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 24-Oct
