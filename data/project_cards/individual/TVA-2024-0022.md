## TVA-2024-0022
+ **Title of the AI use case:**: Advanced Network Anomaly Detection
+ **Agency responsible for the AI use case:**: Tennessee Valley Authority
+ **Agency abbreviation:**: TVA
+ **Specific organization(s) within the agency responsible for the AI use case:**: Network
+ **The topic area that most closely aligns with the AI use case:**: Mission-Enabling
+ **The topic area that most closely aligns with the AI use case:**: 
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: None of the above.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Threat hunting and Security Operations Center (SOC) analysts leverage automated tooling to refine alerts that enable discovery and detection of anomalous behavior across the network. These tools use a massive amount of data and provide intelligence beyond what could be seen from a single vector. Correlated network traffic data with proxy communications help identify compromised systems and networks.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 9/23/2021
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 9/23/2021
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/23/2021
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: PO 7030410
