## DOL-2024-0061
+ **Title of the AI use case:**: Grammarly 14
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Improve writing by correcting grammar, punctuation, and style errors while suggesting tone adjustments. NLP
Grammar Correction
Tone Detection
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Grammatically correct, well-structured, and contextually appropriate text.
