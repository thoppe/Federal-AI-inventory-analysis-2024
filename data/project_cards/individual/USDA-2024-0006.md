## USDA-2024-0006
+ **Title of the AI use case:**: High Throughput Phenotyping in Citrus Orchards
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The main purpose of this system is to analyze drone images to locate, count, and categorize citrus trees in an orchard to monitor orchard health. This use case saves thousands of man-hours searching for signs of plant damage and disease in orchards.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The model output flags images containing plant damage or disease.
...
+ **Date when the AI use case was retired or began the process of retirement:**: 9/30/2022
