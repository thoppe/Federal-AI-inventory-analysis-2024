## USDA-2024-0073
+ **Title of the AI use case:**: Regression, Classification, Clustering with Hilbert Curves
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The purpose of this tool is to perform better regression, classification, and clustering. This will create a new and better ways to produce various estimates, reducing cost and error.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The tools will output Data frame and Raster Surfaces/maps.
