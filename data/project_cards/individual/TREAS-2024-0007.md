## TREAS-2024-0007
+ **Title of the AI use case:**: Winnie Chatbot for Employee IT FAQs
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 12/5/2022
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 9/26/2023
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/26/2023
