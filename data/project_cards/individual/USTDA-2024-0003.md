## USTDA-2024-0003
+ **Title of the AI use case:**: Crowdstrike Falcon Threat Detection and Response
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Crowdstrike uses AI to detect and respond to threats in real-time, such as malware, ransomware, and unauthorized access.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Crowdstrike (FEDRAMP) PK ID FR1807853629
