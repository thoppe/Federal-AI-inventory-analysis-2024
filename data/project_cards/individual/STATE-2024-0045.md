## STATE-2024-0045
+ **Title of the AI use case:**: Image Clustering
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Used a pretrained deep learning model to generate image embeddings, then used hierarchical clustering to identify similar images. This project is retired.
