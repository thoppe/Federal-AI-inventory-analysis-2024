## NTSB-2024-0002
+ **Title of the AI use case:**: Semantic Similarity Text Search
+ **Agency responsible for the AI use case:**: National Transportation Safety Board
+ **Agency abbreviation:**: NTSB
+ **Specific organization(s) within the agency responsible for the AI use case:**: NTSB
+ **The topic area that most closely aligns with the AI use case:**: Mission-Enabling
+ **The topic area that most closely aligns with the AI use case:**: 
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: Searching for information using AI.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Semantic search of agency library of safety recommendation and report texts, improving speed and efficiency of researching previously identified transportation safety topics
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Search results identifying semantically similar narrative in previously published reports and safety recommendations
