## FHFA-2024-0016
+ **Title of the AI use case:**: Network monitoring, anomaly detection through Whats Up Gold and Flowmon integration
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Uses AI for network visibility, anomaly detection, and security through Flowmon integration
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Uses AI for network visibility, anomaly detection, and security through Flowmon integration.
