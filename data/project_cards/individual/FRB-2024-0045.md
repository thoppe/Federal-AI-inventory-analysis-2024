## FRB-2024-0045
+ **Title of the AI use case:**: Bank Performance Monitoring
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Model used to support off site risk analysis
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Econometric model that supplements offsite risk analysis based on
historical ratings
