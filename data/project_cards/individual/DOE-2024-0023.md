## DOE-2024-0023
+ **Title of the AI use case:**: Text To Speech Audio Generation
+ **Agency responsible for the AI use case:**: Department of Energy
+ **Agency abbreviation:**: DOE
+ **Specific organization(s) within the agency responsible for the AI use case:**: KCNSC - Kansas City National Security Campus (KCFO)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: AI tool is used to generate audio files to be used in training content.Allows for faster development of training to meet company needs.  This leads to a cost savings in both initial development and future modifications.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: MP4 Audio Files
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/16/2022
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: N/A - System is used only for GREEN DATA, no OUO or CUI is allowed and does not require a System Security Plan to be named
