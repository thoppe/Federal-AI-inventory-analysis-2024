## SSA-2024-0018
+ **Title of the AI use case:**: Customer Insight Tool
+ **Agency responsible for the AI use case:**: Social Security Administration
+ **Agency abbreviation:**: SSA
+ **Specific organization(s) within the agency responsible for the AI use case:**: Office of Transformation
+ **The topic area that most closely aligns with the AI use case:**: Government Services (includes Benefits and Service Delivery)
+ **The topic area that most closely aligns with the AI use case:**: 
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: None of the above.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Survey analysis tool that evaluates sentiment and categorization.
...
5. Customer Effort - aimed to recover explicit mentions of effort in feedback text
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Survey analysis tool that evaluates sentiment and categorization.
Current capabilities include: 
1. Machine Translation - using algorithms to automatically translate text from one language to another
2. Sentiment Analysis - classifies text into negative, positive and neutral sentiment
3. Categorization - system-generated groupings of conceptually-related words and phrases based on phrase-level feedback
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 9/26/2020
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: Inter-Agency Agreement (IAA-21-0017)
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Customer Feedback Tool (CXFT)
