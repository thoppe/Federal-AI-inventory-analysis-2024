## HHS-2024-0173
+ **Title of the AI use case:**: Resource Capacity Planning
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Forecasting human drug review program submissions and corresponding FDA workload 

Improve the forecasting of human drug review program expected workload in order to adjust fee revenue and fees to fund resources needed to complete expected workload
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Forecasts workload submissions across major user fee programs to support fee setting for the human drug review programs
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: HHSF223201510012B
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: FDA systems including DARRTS and Panorama
