## VA-2024-0056
+ **Title of the AI use case:**: National Training Team | Schools — FAQ Dashboard
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The 1.0 dashboard clusters thousands of submitted questions during a monthly Office Hours session with School Certifying Officials and presents a "top ten" list of associated categories that have the most questions.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Classification and sentiment score
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 4/12/2023
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 4/28/2023
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Question-sets are obtained by exporting them from the monthly office hours sessions in Adobe Connect. These files are used to train and as the model's inputs.
...
+ **Whether communication regarding the provisioning of requested resources for the AI use case has been timely:**: Additional computing resources have not been necessary for this model.
+ **:**: Other
