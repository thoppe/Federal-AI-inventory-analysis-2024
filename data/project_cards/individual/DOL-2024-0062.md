## DOL-2024-0062
+ **Title of the AI use case:**: Adobe Creative Cloud with Acrobat Pro Latest Version
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Intended for enhancing creative workflows by automating repetitive tasks, improving accuracy of search functions, and enabling more advanced image manipulation and video editing. Object recognition
Image Generation
NLP
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Images, Videos, Content
