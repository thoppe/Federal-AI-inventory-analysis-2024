## DHS-2024-0044
+ **Title of the AI use case:**: Advanced Trade Analytics Platform (ATAP)
+ **Agency responsible for the AI use case:**: Department of Homeland Security
+ **Agency abbreviation:**: DHS
+ **Specific organization(s) within the agency responsible for the AI use case:**: CBP
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: To create efficiencies and unlock key insights in CBP's trade mission execution through the application of data analytics, machine learning, and AI.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Model output is provided in dashboards and other visualization mechansims for operator assessment and action determination.
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 3/7/2022
+ **Date when the AI use case was retired or began the process of retirement:**: 
+ **Whether the AI system involved in the use case was developed, or is expected to be developed, exclusively with contracting resources, in-house, or a combination of both:**: Developed with contracting resources.
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: BPA: 70B06C20A00000036  Call Order 1: 70B06C20F00000895 Call Order 2: 70B06C21F00000842 Call Order 3: 70B06C22F00000700 Call Order 4: 70B06C23F00000819 Call Order 5: 70B06C24F00000450
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: ATAP
