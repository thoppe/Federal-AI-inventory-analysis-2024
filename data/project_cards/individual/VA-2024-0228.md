## VA-2024-0228
+ **Title of the AI use case:**: Transcription Services
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: transcribed meetings and interviews
...
+ **Link to publicly available source code for the AI use case, if available, in alignment with OMB Memorandum M-24-10’s section on sharing:**: Https://www.noopensourcedotherusingAzureservices.com
