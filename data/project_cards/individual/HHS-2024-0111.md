## HHS-2024-0111
+ **Title of the AI use case:**: Drug cost anomaly detection
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: CMS Division of Payment Reconciliation is responsible for monitoring Prescription Drug Event  (PDE) data for accuracy

Allows for identification of outliers in PDE which can be corrected through Part D plan outreach in order to prevent overpayments.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Identify anomalies in drug costs on Part D claims
