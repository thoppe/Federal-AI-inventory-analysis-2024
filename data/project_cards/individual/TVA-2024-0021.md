## TVA-2024-0021
+ **Title of the AI use case:**: ArcGIS
+ **Agency responsible for the AI use case:**: Tennessee Valley Authority
+ **Agency abbreviation:**: TVA
+ **Specific organization(s) within the agency responsible for the AI use case:**: GIS
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Platform for mapping, analyzing, managing, and viewing geospatial data. It is designed to support and integrate with a variety of GIS services, providing a robust solution for organizations to leverage spatial information.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Maps, spatial analysis, image processing and image analysis
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 4/17/2023
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 6/10/2023
+ **Date when the AI use case was fully implemented and deployed into use:**: 7/27/2023
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: GIS data, ESRI, image data, Maximo data
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: ArcGIS ESRI
