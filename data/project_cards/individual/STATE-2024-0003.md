## STATE-2024-0003
+ **Title of the AI use case:**: Property and Procurement Analytics
+ **Agency responsible for the AI use case:**: Department of State
+ **Agency abbreviation:**: STATE
+ **Specific organization(s) within the agency responsible for the AI use case:**: A/GO
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Plan to expand current analytics within the Integrated Logistics Management System (ILMS) through development of a machine learning model for detecting patterns of potential anomalous activity in property and procurement.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Plan to have data on potential anomalous activity.
