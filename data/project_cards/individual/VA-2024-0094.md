## VA-2024-0094
+ **Title of the AI use case:**: HCD User Feedback Summary, Analysis, and Design
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The Human-Centered Design (HCD) team uses Large Language Models (LLMs) and custom agents to enhance user experience (UX) research. The primary purpose is to improve the usability, accessibility, and clarity of user feedback, providing a better understanding of the needs of Veterans and healthcare providers.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The AI system generates insights, such as user stories, personas, and workshop summaries, which are used to inform design decisions.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: SDP ID: 1301
