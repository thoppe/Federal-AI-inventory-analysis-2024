## DOE-2024-0018
+ **Title of the AI use case:**: CAISY
+ **Agency responsible for the AI use case:**: Department of Energy
+ **Agency abbreviation:**: DOE
+ **Specific organization(s) within the agency responsible for the AI use case:**: HC HQ -  Office of the Chief Human Capital Officer (HC)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: 1. CAISY provides interactive, scenario-based content powered by AI where a learner can practice new skills in a safe space. This AI simulation content allows learners to choose a role, practice specific skills by responding to AI prompts, and receive adaptive, personalized feedback to guide their development
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: speech-to-text (STT) and text-to-speech (TTS) services for more immersive and natural interaction.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 1/4/2024
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 8/21/2024
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: None of the above
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: PERCIPIO/CAISY
