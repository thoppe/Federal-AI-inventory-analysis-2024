## DOI-2024-0151
+ **Title of the AI use case:**: Using Machine Learning in USGS StreamStats to make suspended sediment and bedload predictions
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: A tool for resource managers who need estimates of suspended sediment and bedload in Minnesota rivers without sampling data.
