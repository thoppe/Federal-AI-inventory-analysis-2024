## HUD-2024-0002
+ **Title of the AI use case:**: Subledger Data Quality Machine Learning
+ **Agency responsible for the AI use case:**: Department of Housing and Urban Development
+ **Agency abbreviation:**: HUD
+ **Specific organization(s) within the agency responsible for the AI use case:**: Ginnie Mae
