## FRB-2024-0049
+ **Title of the AI use case:**: Risk Rating Model- Community Banks
+ **Agency responsible for the AI use case:**: Board of Governors of the Federal Reserve System
+ **Agency abbreviation:**: FRB
+ **Specific organization(s) within the agency responsible for the AI use case:**: Division of Supervision and Regulation
+ **The topic area that most closely aligns with the AI use case:**: Government Services (includes Benefits and Service Delivery)
+ **The topic area that most closely aligns with the AI use case:**: 
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: None of the above.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: To improve upon the risk classification framework used to tier community banks according to risk, and to tailor examination intensity according to risk
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Statistical methods are used in the variable selection process for a risk model
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 5/1/2020
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 5/2/2020
+ **Date when the AI use case was fully implemented and deployed into use:**: 10/30/2023
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Internal- FFIEC Call Report, Uniform Bank Performance Report
...
+ **Whether communication regarding the provisioning of requested resources for the AI use case has been timely:**: This use case does not require intensive compute resources, but yes there is a process for requesting access to the compute environment where models are trained/estimated.
+ **:**: Yes
