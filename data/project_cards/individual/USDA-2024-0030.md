## USDA-2024-0030
+ **Title of the AI use case:**: Automated PDF Document Processing and Information Extraction
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This use case takes program and workforce related information stored in thousands of PDFs and converts the information into data tables that can be used for analytics and dashboards. This makes information that is difficult to find available in real-time to support decision making and saves large amounts of time compared to previous methods used.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The model outputs structured database tables.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 10/15/2022
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 10/24/2022
+ **Date when the AI use case was fully implemented and deployed into use:**: 1/15/2023
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Microsoft Power Automate
