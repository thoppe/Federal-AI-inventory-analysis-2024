## HHS-2024-0214
+ **Title of the AI use case:**: Federal IT Acquisition Reform Act (FITARA) Tool
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: NIAID administers contracts to execute mission initiatives.

The tool's classifications inform SOW clarifications/revisions relevant to the FITARA.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The tool classifies contract statement of work (SOW) documents as being IT-related or not.
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 7/1/2017
