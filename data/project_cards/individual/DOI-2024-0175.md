## DOI-2024-0175
+ **Title of the AI use case:**: Autonomous Drone Inspections
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: BSEE has entered into an Interagency Agreement with the Massachusetts Institute of Technology (MIT) Lincoln Laboratory (LL) to research autonomous unmanned aerial systems (UAS) and sensor technologies, with the goal of extending BSEE’s inspection capabilities to previously inaccessible environments on the Outer Continental Shelf (OSC). This research aims to build upon and leverage the work conducted by NASA's Advanced Supercomputer Division on corrosion models developed for the Level 1 Survey Report's Corrosion Level Classifications.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Multiple outputs for inspections, including decisions on corrosion levels, if a platform is boardable, does it have methane leaks.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 5/13/2022
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: IAA E24PG00019
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: The model development stage has not yet begun. Currently in information gathering stage.
