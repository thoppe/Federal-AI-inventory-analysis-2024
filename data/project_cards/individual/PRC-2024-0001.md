## PRC-2024-0001
+ **Title of the AI use case:**: Lexis +AI
+ **Agency responsible for the AI use case:**: Postal Regulatory Commission
+ **Agency abbreviation:**: PRC
+ **Specific organization(s) within the agency responsible for the AI use case:**: OGC
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Legal Research
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Research
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: Sole Source
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Lexis +AI
