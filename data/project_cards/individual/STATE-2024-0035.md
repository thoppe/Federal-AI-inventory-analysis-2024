## STATE-2024-0035
+ **Title of the AI use case:**: NLP to pull key information from unstructured text
+ **Agency responsible for the AI use case:**: Department of State
+ **Agency abbreviation:**: STATE
+ **Specific organization(s) within the agency responsible for the AI use case:**: PM
