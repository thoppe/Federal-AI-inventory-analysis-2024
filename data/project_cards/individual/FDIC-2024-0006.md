## FDIC-2024-0006
+ **Title of the AI use case:**: Content Creation
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Reducing time to create content, increase volume of content, provide content for students who struggle to take notes and engage in class.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Generative, Provides interactive resources used for training.
