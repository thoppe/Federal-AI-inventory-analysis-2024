## FTC-2024-0003
+ **Title of the AI use case:**: Chatbot
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Delivers unattended chat 24/7 for Identity Tehft.gov and ReportFraud.gov after business hours. Assisted chat is only available during business hours.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Chats
