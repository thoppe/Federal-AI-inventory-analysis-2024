## FDIC-2024-0033
+ **Title of the AI use case:**: CFOO Admin Chatbot
+ **Agency responsible for the AI use case:**: Federal Deposit Insurance Corporation
+ **Agency abbreviation:**: FDIC
+ **Specific organization(s) within the agency responsible for the AI use case:**: Division of Finance
+ **The topic area that most closely aligns with the AI use case:**: Mission-Enabling
+ **The topic area that most closely aligns with the AI use case:**: 
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: None of the above.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Compiling data from internal FDIC website and targeted documents to answer questions about CFOO admin. Makes information more readily available to the public, searchable and readable.
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 1/10/2023
+ **Date when the AI use case was fully implemented and deployed into use:**: 6/13/2023
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: CFOO (Chief Financial Officer Organization) Admin Chatbot use the FDIC CFOO Administrative data set for training. The data contains administrative data elements. The administrative data set is internally available for all the FDIC employees and contractors.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Internal Chatbot Rasa (ICR) - Admin Chatbot
