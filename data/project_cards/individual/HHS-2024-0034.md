## HHS-2024-0034
+ **Title of the AI use case:**: Adverse Childhood Experiences (ACEs) Literature Review Dashboard
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: This solution automatically determines the relevancy of published journal articles. Relevant articles are included in a master dataset that is linked to a PowerBI
