## USAID-2024-0020
+ **Title of the AI use case:**: Market segmentation
+ **Agency responsible for the AI use case:**: United States Agency for International Development
+ **Agency abbreviation:**: USAID
+ **Specific organization(s) within the agency responsible for the AI use case:**: USAID/Bureau for Global Health (GH)
...
+ **Date when the AI use case was retired or began the process of retirement:**: 7/16/1905
+ **Whether the AI system involved in the use case was developed, or is expected to be developed, exclusively with contracting resources, in-house, or a combination of both:**: Developed with contracting resources.
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 7200AA19CA0004
