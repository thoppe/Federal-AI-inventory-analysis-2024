## DOI-2024-0037
+ **Title of the AI use case:**: PyForecast
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Pyforecast is a statistical/ML water supply forecasting software developed by Reclamation that uses a range of data-driven methods.
...
+ **Description of how the agency is ensuring that this AI use case is compliant with Information Quality Act guidelines and OMB Memorandum M-19-15, if applicable:**: Actitivity yielded forecasting tool that was peer reviewed to the rigor required for influential scientific information, per IQA.
