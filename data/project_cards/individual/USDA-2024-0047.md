## USDA-2024-0047
+ **Title of the AI use case:**: DISTRIB-II: Habitat Suitability of Eastern United States Tree
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 4/10/1998
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 5/16/2016
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/12/2019
...
+ **Description of how the agency is ensuring that this AI use case is compliant with Information Quality Act guidelines and OMB Memorandum M-19-15, if applicable:**: The input data and predictions have been evaluated using standard statistical methods, reviewed by several experts and many users, and the project has been published in several peer-reviewed journals.
