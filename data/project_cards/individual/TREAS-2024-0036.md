## TREAS-2024-0036
+ **Title of the AI use case:**: Taxpayer 90 (Palantir prototype)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Palantir AIP will interact with synthetic data and public information (e.g. IRM and tax forms) to summarize documentation and parse through information more quickly. AIP is enabled within SaaS platform (only within SaaS, no firewall changes/proxy exceptions needed), shared with Selection aNd Analytic Platform (SNAP), but AIP is only permissioned to users with the Taxpayer 90 Business Entitlement Access Request System (BEARS) entitlement. Data is contained within the Software as a Service (SaaS) tenant.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Summary of synthetic data and public information (e.g. Internal Revenue Manual (IRM) and tax forms).
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 10/30/2024
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 9/4/2024
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 2032H5-18-A-00029
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Test data provided only for prototype development
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: SNAP-TP90
