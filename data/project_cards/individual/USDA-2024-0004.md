## USDA-2024-0004
+ **Title of the AI use case:**: Predictive Modeling of Invasive Pest Species
+ **Agency responsible for the AI use case:**: Department of Agriculture
+ **Agency abbreviation:**: USDA
+ **Specific organization(s) within the agency responsible for the AI use case:**: APHIS: Animal and Plant Health Inspection Service
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The model outputs are a prediction of whether a product carries an invasive species and what invasive species category the pest belongs to.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 7/1/2015
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 7/1/2015
+ **Date when the AI use case was fully implemented and deployed into use:**: 5/1/2018
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Inspection data was collected from Plant Protection and Quarantine (PPQ) and Customs and Border Protection (CBP). Quality control of the data was conducted by data analysts. There was no data augmention performed. The data is structured and has several million records with more than 50 numerical and categorical variables. This data is not publicly available.
