## TVA-2024-0006
+ **Title of the AI use case:**: Materials tracking
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Use predictive analytics and confidence levels to track materials as they go through the supply chain process and risk on being delivered on time
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Dashboard for monitoring where in the supply chain process, item is and if it is at risk for being late
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 1/5/2020
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 1/5/2020
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: MS Azure, PowerBI
