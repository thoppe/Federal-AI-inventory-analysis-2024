## VA-2024-0054
+ **Title of the AI use case:**: VA CART Adenoma Detection NLP
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Extracts adenoma status for CART Veterans using Natural Language Processing (NLP) of VistA colonoscopy surgical pathology reports
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Results contain 0 for no evidence of adenoma or 1 for evidence of adenoma in the pathology report
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 1/8/2024
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 5/31/2024
+ **Date when the AI use case was fully implemented and deployed into use:**: 7/31/2024
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: VistA colonoscopy surgical pathology reports
...
+ **Identification of the other demographic features explicitly utilized in the AI use case’s data/model(s), if any:**: VistA colonoscopy surgical pathology reports
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Clinical Assessment, Reporting and Tracking Application (VASI ID 1079, EMAS ID 1808)
