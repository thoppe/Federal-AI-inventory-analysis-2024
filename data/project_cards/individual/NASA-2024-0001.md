## NASA-2024-0001
+ **Title of the AI use case:**: NextGen Advanced Methods: Air Traffic Control System Command Center (ATCSCC) Webinar Speech2Text and Analysis
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: ATCSCC
...
+ **Whether the AI use case promotes re-use of existing infrastructure to promote AI development:**: This project leveraged external NLP work
