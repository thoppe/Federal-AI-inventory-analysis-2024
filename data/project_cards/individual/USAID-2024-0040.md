## USAID-2024-0040
+ **Title of the AI use case:**: MENA Assessment Chatbot
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: MENA Assessment Chatbot searches a defined repository of USAID-funded assessments to return information in response to questions
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: A chatbot responds to questions based on its repository of reports and assessments
