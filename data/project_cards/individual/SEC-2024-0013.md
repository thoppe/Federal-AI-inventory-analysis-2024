## SEC-2024-0013
+ **Title of the AI use case:**: Public Filing Disclosure Review
+ **Agency responsible for the AI use case:**: Securities and Exchange Commission
+ **Agency abbreviation:**: SEC
+ **Specific organization(s) within the agency responsible for the AI use case:**: Office of the Chief Data Officer (OCDO)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Summarizes public filing disclosures and identifying differences and similarities between disclosures.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Summaries of disclosures and answers to user-selected questions.
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 50310224F0089
