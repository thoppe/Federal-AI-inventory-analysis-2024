## DHS-2024-0120
+ **Title of the AI use case:**: CFO Companion
+ **Agency responsible for the AI use case:**: Department of Homeland Security
+ **Agency abbreviation:**: DHS
+ **Specific organization(s) within the agency responsible for the AI use case:**: MGMT
+ **The topic area that most closely aligns with the AI use case:**: Mission-Enabling
+ **The topic area that most closely aligns with the AI use case:**: 
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: None of the above.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Provides authorized staff with an intuitive, conversational interface to query and analyze DHS CFO financial data and reports.
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: On-demand information retrieval via natural language processing.
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 4/8/2024
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 70RDAD22FR0000064
...
+ **Explanation for whether the AI use case made use of agency-wide infrastructure to quickly identify the rights datasets to begin model development:**: OCFO uses Collibra, through CDOD's Matrix environment. The catalog build-out is WIP
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Internal system and process information, such as the link to a visualization, or data attribute information tied to publicly available finanacial data.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: CFO Horizon
