## TREAS-2024-0013
+ **Title of the AI use case:**: Economic Impact Payment (EIP) FAQ Voicebot
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Provide caller with information on Economic Impact Payment (EIP).
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 4/9/2021
+ **Date when the AI use case was fully implemented and deployed into use:**: 5/5/2021
