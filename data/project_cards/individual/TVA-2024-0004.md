## TVA-2024-0004
+ **Title of the AI use case:**: CAP Automation
+ **Agency responsible for the AI use case:**: Tennessee Valley Authority
+ **Agency abbreviation:**: TVA
+ **Specific organization(s) within the agency responsible for the AI use case:**: Enterprise Analytics & Innovation
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Use NLP to classify condition reports as C, E, or WO level
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: A classification label - C, E, or WO
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 5/19/2023
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 5/19/2023
+ **Date when the AI use case was fully implemented and deployed into use:**: 4/24/2024
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Condition reports
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Python application
