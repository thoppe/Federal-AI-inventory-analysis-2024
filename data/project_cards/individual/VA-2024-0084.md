## VA-2024-0084
+ **Title of the AI use case:**: Silverberry Surgery Planning AI
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Assist in planning and operations in the perioperative process including sps, supplies, personell requirements and patinet planning.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Output will be multiple AI agents responsible for various tasks related to the peri operative process.
