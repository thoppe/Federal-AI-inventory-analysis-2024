## DOI-2024-0008
+ **Title of the AI use case:**: Liable Party Research
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Supervised machine learning model for scraping leasing documents for current liable party ownership.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Efficient liable party ownership.
