## HUD-2024-0001
+ **Title of the AI use case:**: Counterparty Risk Anomaly Detection
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: GSQ1117BJ0043
