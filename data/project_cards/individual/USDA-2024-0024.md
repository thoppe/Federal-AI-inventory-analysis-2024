## USDA-2024-0024
+ **Title of the AI use case:**: Operational Water Supply Forecasting for Western US Rivers
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The National Water and Climate Center has a multi-model machine-learning metasystem (M4) for generating water supply forecasts. This model uses AI and other data-science technologies to reduce forecast errors, helping stakeholders make better decisions about water supply availability.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The model outputs water supply forecasts.
...
+ **Identification of the High-Impact Service Provider (HISP) that the AI use case supports:**: Natural Resources Conservation Service - USDA
+ **Identification of the specific public-facing service that the AI use case supports:**: Applying for the Environmental Quality Incentives Program (EQIP)
