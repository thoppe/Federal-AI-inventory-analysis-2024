## DOI-2024-0116
+ **Title of the AI use case:**: Intelligent National Map project
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The Intelligent National Map is a vision by the U.S. Geological Survey (USGS) to make mapping smarter by using advanced technology like artificial intelligence (AI). This project aims to create maps that can update themselves automatically, detect changes in the environment, and provide better, faster information for decisions about land, water, and natural resources.
