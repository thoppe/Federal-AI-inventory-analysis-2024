## DOL-2024-0058
+ **Title of the AI use case:**: Tableau Public 2023
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Allows users to share data visualizations, providing interactive insights.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Interactive visualizations such as charts, graphs, and dashboards that are easy to interpret and share. Data visualization
Data Classification
