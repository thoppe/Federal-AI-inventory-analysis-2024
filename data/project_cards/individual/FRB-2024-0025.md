## FRB-2024-0025
+ **Title of the AI use case:**: Anomaly Detection
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Improve the iterative data quality process
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Suggested messages regarding data quality of subsets of firm submitted data based on similar historical messages
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 12/1/2022
