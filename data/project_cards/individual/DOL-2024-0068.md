## DOL-2024-0068
+ **Title of the AI use case:**: Westlaw Precision & CoCounsel
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Helps professionals find relevant case law, statutes, and legal precedents.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Legal documents, case analysis, and predictions for legal outcomes.
