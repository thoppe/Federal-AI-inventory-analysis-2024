## FRB-2024-0019
+ **Title of the AI use case:**: Newsfeed Data Transformations
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Applying labels for country of origin and topic to articles
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Article labels for entities, topics, and sentiment
