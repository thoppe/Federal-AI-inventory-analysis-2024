## USAID-2024-0035
+ **Title of the AI use case:**: National Park information classification using AI, Garamba National Park, DRC
+ **Agency responsible for the AI use case:**: United States Agency for International Development
+ **Agency abbreviation:**: USAID
+ **Specific organization(s) within the agency responsible for the AI use case:**: USAID/Democratic Republic of the Congo
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Integrated Python scripting to train the J2/intelligence office workflow on how information from park ranger patrols should be classified, separated, then shared from the confidential data.
