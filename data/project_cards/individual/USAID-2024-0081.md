## USAID-2024-0081
+ **Title of the AI use case:**: Intelligent forecasting for Family Planning products (Cote d'Ivoire)
+ **Agency responsible for the AI use case:**: United States Agency for International Development
+ **Agency abbreviation:**: USAID
+ **Specific organization(s) within the agency responsible for the AI use case:**: USAID/Bureau for Global Health
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Optimizing health supply chains to reduce costs and improve quality of care by avoiding stock-outs.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Supply chain predictions
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 7200AA20CA00009
