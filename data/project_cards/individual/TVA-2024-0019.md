## TVA-2024-0019
+ **Title of the AI use case:**: Prism Models for MDM
+ **Agency responsible for the AI use case:**: Tennessee Valley Authority
+ **Agency abbreviation:**: TVA
+ **Specific organization(s) within the agency responsible for the AI use case:**: Monitoring Diagnostics Management
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Use of clustering and nearest neighbor models to analyze analog signal data looking for variations in signals. Goal is to detect signal anomalies and provide alarms on deviations.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: OMR - measure of how far current vector is from normal . Output includes an automated generated emails for human in the loop validation
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 5/1/2013
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 5/1/2013
+ **Date when the AI use case was fully implemented and deployed into use:**: 10/1/2013
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Prism
