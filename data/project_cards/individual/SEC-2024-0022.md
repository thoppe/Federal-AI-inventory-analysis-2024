## SEC-2024-0022
+ **Title of the AI use case:**: Testing of Various AI Algorithms and Models
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Experimentation using technology to determine if appropriate to enhance examiner efficiency, productivity, or effectiveness.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 24-Apr
