## FRB-2024-0043
+ **Title of the AI use case:**: Outlier Detection
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Traditional AI to help identify, synthesize, and deliver information provided by firms.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Identify, Synthesize, and Deliver Information from firms
