## USDA-2024-0049
+ **Title of the AI use case:**: ROE Document Recognition - RoeDR
+ **Agency responsible for the AI use case:**: Department of Agriculture
+ **Agency abbreviation:**: USDA
+ **Specific organization(s) within the agency responsible for the AI use case:**: RMA: Risk Management Agency
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The model outputs the producer signature and signature date within document as text.
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 5/23/2024
+ **Date when the AI use case was fully implemented and deployed into use:**: 6/12/2024
