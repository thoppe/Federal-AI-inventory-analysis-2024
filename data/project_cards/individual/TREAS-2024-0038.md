## TREAS-2024-0038
+ **Title of the AI use case:**: Transcription -- Evidence.com
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Evidence.com provides an accurate AI based transcription tool for law enforcement recordings.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The evidence.com site produces a word document.
