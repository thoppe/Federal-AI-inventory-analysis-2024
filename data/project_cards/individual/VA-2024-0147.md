## VA-2024-0147
+ **Title of the AI use case:**: Operationalizing Coronary Artery Calcium Computer Vision Model
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This AI model's purpose is to screen Chest CT scans for coronary artery calcification and notify physicians of patients with increased cardiovascular risk. This will help physicians detect cardiovascular disease earlier and better treat their patients.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The model will output a coronary artery calcium score and also output image masks showing physicians where the model detected coronary artery calcium on the patients chest images.
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 5/5/2023
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: VA Imaging data, VINCI-CDW based data
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: ARCHES, VA Long Beach AIOC
