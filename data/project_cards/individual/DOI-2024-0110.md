## DOI-2024-0110
+ **Title of the AI use case:**: Lava lake thermal pattern classification using self organizing maps and relationships to eruption pr
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: We apply a machine learning algorithm called self-organizing maps (SOM) to thermal infrared time-lapse images .
