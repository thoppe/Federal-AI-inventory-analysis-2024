## USAID-2024-0046
+ **Title of the AI use case:**: SERVIR Agriculture and Food Security: SERVIR is using machine learning techniques to interpret satellite data to improve crop area, crop type, crop condition, and yield estimates at the scale of 10s of meters, aggregated to country, district, province, or country.
+ **Agency responsible for the AI use case:**: United States Agency for International Development
+ **Agency abbreviation:**: USAID
+ **Specific organization(s) within the agency responsible for the AI use case:**: USAID/Bureau for Resilience, Environment, and Food Security
