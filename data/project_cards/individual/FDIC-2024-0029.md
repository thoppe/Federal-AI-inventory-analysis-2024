## FDIC-2024-0029
+ **Title of the AI use case:**: Structured Interview (SI) tool
+ **Agency responsible for the AI use case:**: Federal Deposit Insurance Corporation
+ **Agency abbreviation:**: FDIC
+ **Specific organization(s) within the agency responsible for the AI use case:**: Division of Administration
+ **The topic area that most closely aligns with the AI use case:**: Mission-Enabling
+ **The topic area that most closely aligns with the AI use case:**: 
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: None of the above.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The FDIC seeks to improve the personnel selection process by automating the scheduling, creation, administration, scoring, and maintenance of structured interview materials using an online platform.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The SI (Interview) tool will securely house a large number of internally developed, competency-based structured interview questions.
