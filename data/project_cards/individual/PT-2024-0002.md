## PT-2024-0002
+ **Title of the AI use case:**: Ability to find information through search results and other methods
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Improved finding of information
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Search results, translation, questions answered
