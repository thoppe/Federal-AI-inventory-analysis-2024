## USDA-2024-0077
+ **Title of the AI use case:**: Predictive flood modeling
+ **Agency responsible for the AI use case:**: Department of Agriculture
+ **Agency abbreviation:**: USDA
+ **Specific organization(s) within the agency responsible for the AI use case:**: FS: Forest Service; USDOT: US Department of Transportation
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The purpose of this tool is to predict water flow during floods and assesses the vulnerability of drains under roads. This will help U.S. Department of Transportation (USDOT) and USDA Forest Service to make informed decisions in drain restoration and protection against flooding.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The model outputs water flow predictions during flood events and the vulnerability level of drains under roads.
