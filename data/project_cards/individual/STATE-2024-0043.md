## STATE-2024-0043
+ **Title of the AI use case:**: TOPIQ
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Automatically categorized text into topics for analyst review and interpretation, using Latent Dirichlet Allocation (LDA), to extract topics from documents and then assigned the probability that each document belonged to a topic. This project is retired.
