## FRB-2024-0015
+ **Title of the AI use case:**: Bank Subsidiary Identification
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Identifying auto loans reported as subsidiaries of the banks
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Identification of loans issued by finance company subsidiaries of banks
