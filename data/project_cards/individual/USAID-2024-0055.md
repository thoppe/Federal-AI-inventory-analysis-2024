## USAID-2024-0055
+ **Title of the AI use case:**: LIDA: Instant Messaging System in the Family Commissioner's Office of Montería - Córdoba, Colombia
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The LIDA instant messaging system in the Family Commissioner´s Office of Montería,  seeks to strengthen communication channels with citizens and strengthen the promotion  of rights, based on knowledge of gender-based violence (GBV) referral pathways.
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 72051422D00001
