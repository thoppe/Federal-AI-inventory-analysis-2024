## DOL-2024-0067
+ **Title of the AI use case:**: Adobe Creative Cloud / Adobe Express AI feature
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Helps users create visual content quickly through AI-driven automation.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Graphics, posters, and social media content. Image Generation
Content Creation
