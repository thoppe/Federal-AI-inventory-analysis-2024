## FDIC-2024-0038
+ **Title of the AI use case:**: Risk Identification and Response
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Apply a risk model to identified risks and incorporate additional data sets to identify any correlations or possible solutions. Reduce risk to corporation by being able to more quickly and accurately analyze and report out on data.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: A recommendation of any correlations among risk data and a report including possible solutions
