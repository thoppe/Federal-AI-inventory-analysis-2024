## DOI-2024-0064
+ **Title of the AI use case:**: Reinforcement Learning for Helmholtz Coil Operation and Simulation
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The USGS is using AI/ML to optimize performance of its magnetic observatories. For example, reinforcement learning (RL) can significantly aid in the operation of a Helmholtz coil by optimizing its performance in generating uniform magnetic fields.
