## FRB-2024-0035
+ **Title of the AI use case:**: Writing Quality Analysis Model
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: A NLP model to help leaders better understand the writing quality and consistency of documents
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Provides analysis score of consistency of writing style
