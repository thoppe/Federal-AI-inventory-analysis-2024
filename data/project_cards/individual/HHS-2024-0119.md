## HHS-2024-0119
+ **Title of the AI use case:**: Innovation Center Investment Proposal (ICIP) Model Analysis POC
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: It will affect the process of document analysis, specifically the analysis of ICIP documents.

It will help in  ICIP document analysis, with the goal of extracting of insights and recommendations from these documents.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: It will extract relevant insights and recommendations from the ICIPs, making use of a RAG-based architecture, and present them through a natural language interface. This interface will allow users to interact with the documents and retrieve the information they need easily.
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: PPMS
