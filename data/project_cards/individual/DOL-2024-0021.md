## DOL-2024-0021
+ **Title of the AI use case:**: Notice of Deficiency (NOD) Text Generation using Generative AI model
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Application of custom Generative AI model to create Notice of Deficiency (NOD) text based on the input data
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Natural language text generation
