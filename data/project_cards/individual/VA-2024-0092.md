## VA-2024-0092
+ **Title of the AI use case:**: Lyssn for Mental Health
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/5/2023
...
+ **Identification of the demographic features explicitly utilized in the AI use case’s data/model(s), if any:**: ["Ability Status"]
