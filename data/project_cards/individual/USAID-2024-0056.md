## USAID-2024-0056
+ **Title of the AI use case:**: AI assistant for Colombia Partners for Transparency
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This tool combines Large Language Models (LLM) with Retrieval-Augmented Generation (RAG) to enhance interaction with the PfT documentation. It allows users to upload documents in word and pdf and ask natural language questions, similar to ChatGPT, providing precise and contextually answers based on the specific content of the documents (https://www.evidencebase.ai/)
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 72051420CA00001
