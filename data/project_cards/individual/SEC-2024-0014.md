## SEC-2024-0014
+ **Title of the AI use case:**: EDGAR Technical Support Public Chatbot
+ **Agency responsible for the AI use case:**: Securities and Exchange Commission
+ **Agency abbreviation:**: SEC
+ **Specific organization(s) within the agency responsible for the AI use case:**: EDGAR Business Office (EBO)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Provides public users quick answers to technical questions about accessing EDGAR.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Responses or links to existing technical documentation.
