## FDIC-2024-0001
+ **Title of the AI use case:**: Invoice and Contract Data Extraction
+ **Agency responsible for the AI use case:**: Federal Deposit Insurance Corporation
+ **Agency abbreviation:**: FDIC
+ **Specific organization(s) within the agency responsible for the AI use case:**: Chief Information Officer Organization
+ **The topic area that most closely aligns with the AI use case:**: Mission-Enabling
+ **The topic area that most closely aligns with the AI use case:**: 
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: None of the above.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The purpose is to extract data from invoices and contracts (PDFs) and use the data for reconciliation.  The benefit is to improve the accuracy of invoice and  contract reconciliation and to reduce the time for Oversight Managers (OMs) to perform this activity.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The system generates an excel output sent via email to OMs that show the results of the reconciliation, including discrepancies and errors.
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 4/15/2024
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Data from FDIC invoices and contracts
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Commodities Invoice Reconciliation
