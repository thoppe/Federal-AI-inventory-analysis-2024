## USAID-2024-0110
+ **Title of the AI use case:**: RAG system for FEWS NET food security reports
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The FEWS NET Data, Learning and Communications Hub is developing an AWS SageMaker backed, Retrieval-Augmented Generation (RAG) model utilizing 40 years of historical FEWS NET food security reports. This allows analysts to use natural language to quickly search and retrieve relevant information, with links to the original reports. This model ensures that the wealth of historical FEWS NET food security analysis is accessible. The result is a more informed, data-driven foundation for future project decisions.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Text responses to queries
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 7200AA24F00008
