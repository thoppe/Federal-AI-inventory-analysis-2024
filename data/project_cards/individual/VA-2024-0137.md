## VA-2024-0137
+ **Title of the AI use case:**: Nuance Dragon Medical One (DMO)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Documentation is entered into the electronic health record leveraging voice to text technology
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Voice-generated content and turn it into clinical documentation
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: EWSR DMO -E ID: 1206
