## DOC-2024-0034
+ **Title of the AI use case:**: Coastal Change Analysis Program (C-CAP)
+ **Agency responsible for the AI use case:**: Department of Commerce
+ **Agency abbreviation:**: DOC
+ **Specific organization(s) within the agency responsible for the AI use case:**: NOAA - National Oceanic and Atmospheric Administration
