## VA-2024-0023
+ **Title of the AI use case:**: ECG/EKG Machines- Interpretation of Results
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This software aids with interpretation of  clinical Electrocardiogram tracings for VA clinicians.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The system integrates w/ CPRS and outputs patient demographics on the ECG print-out.  It then prints a list of notable findings from the ECG on the form that is later reviewed and confirmed or overturned by a licensed provider.   In many cases, the machine interpretation is correct and is confirmed by the provider.
...
+ **Description of how the agency is ensuring that this AI use case is compliant with Information Quality Act guidelines and OMB Memorandum M-19-15, if applicable:**: This is a commercial OTC system that has been validated in clinical use over a period of years.  It is compliant w/ VA OIT guidelines as it does operate on VA's network and interfaces with CPRS.
...
+ **Explanation for whether the AI use case made use of agency-wide infrastructure to quickly identify the rights datasets to begin model development:**: The AI algorithm is validated by the manufacturer before the product is approved for use.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Macview 360
...
+ **:**: Other
+ **Explanation for whether communication regarding the provisioning of requested resources for the AI use case has been timely:**: Unit is OTS ready.  No provisioning is needed.
