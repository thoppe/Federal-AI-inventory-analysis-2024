## DOL-2024-0014
+ **Title of the AI use case:**: Automatic Data Processing Workflow with Form Recognizer
+ **Agency responsible for the AI use case:**: Department of Labor
+ **Agency abbreviation:**: DOL
+ **Specific organization(s) within the agency responsible for the AI use case:**: ETA
