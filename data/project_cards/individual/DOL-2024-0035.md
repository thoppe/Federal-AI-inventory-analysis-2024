## DOL-2024-0035
+ **Title of the AI use case:**: Note taking bot
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The bot will take the transcript and summarize the meeting notes
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The output will be a transcript of the meeting and from the transcript summary and action items
