## DOL-2024-0070
+ **Title of the AI use case:**: Microsoft Office Suite
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Microsoft Office Suite is a collection of productivity software applications developed by Microsoft. It is widely used for various personal, educational, and business tasks
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: create slideshows combining text, images, and multimedia. creating, editing, and formatting text documents
