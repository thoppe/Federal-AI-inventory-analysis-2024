## NSF-2024-0014
+ **Title of the AI use case:**: Open-source topic identification for the Public Engagement with Science Initiative data analysis.
+ **Agency responsible for the AI use case:**: National Science Foundation
+ **Agency abbreviation:**: NSF
+ **Specific organization(s) within the agency responsible for the AI use case:**: OD/OIA
