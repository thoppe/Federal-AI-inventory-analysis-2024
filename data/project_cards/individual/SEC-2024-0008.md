## SEC-2024-0008
+ **Title of the AI use case:**: Create Work-Related Videos
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Allows staff to make and edit work-related videos.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: A video is created, which may be edited.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 24-Nov
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 23-Jun
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 47QTCA21D007B/50310223F0119/P00001
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Vyond
