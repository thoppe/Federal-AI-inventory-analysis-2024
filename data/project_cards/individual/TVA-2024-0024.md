## TVA-2024-0024
+ **Title of the AI use case:**: Vulnerability Tracking
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 2/22/2024
+ **Date when the AI use case was fully implemented and deployed into use:**: 2/22/2024
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: PO 7596319
