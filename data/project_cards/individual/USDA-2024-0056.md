## USDA-2024-0056
+ **Title of the AI use case:**: Dynamic Soils Hub
+ **Agency responsible for the AI use case:**: Department of Agriculture
+ **Agency abbreviation:**: USDA
+ **Specific organization(s) within the agency responsible for the AI use case:**: NRCS: Natural Resources Conservation Service
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The Dynamic Soils Hub (DS Hub) under the Natural Resources Conservation Service (NRCS) is a tool designed to help both government workers and the public understand and analyze soil information. The DS Hub links different soil and conservation databases, making it easier to evaluate the environmental benefits of conservation programs by accessing previously separate data and models. This enhances the USDA’s ability to study and report on how soil properties change with conservation efforts over time.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The system outputs the class of soil based on the supplied soil information.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 11/11/2020
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 11/11/2020
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Dynamic Soils Hub
