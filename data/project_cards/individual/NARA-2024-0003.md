## NARA-2024-0003
+ **Title of the AI use case:**: Auto-fill of Descriptive Metadata for Archival Descriptions
+ **Agency responsible for the AI use case:**: National Archives and Records Administration
+ **Agency abbreviation:**: NARA
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: NARA is using AI to automatically create descriptions (metadata) for its digital archives. This will save archivists time, make records easier to find, and help the public better understand the information in the National Archives Catalog.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: This AI use case will create more complete and informative descriptions for records, making them easier to find in the National Archives Catalog.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Description and Authority Service (DAS)
