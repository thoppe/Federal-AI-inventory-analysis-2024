## VA-2024-0058
+ **Title of the AI use case:**: Audit of Service Connection Designations Associated with Prescriptions
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Reduction in waste, fraud and abuse.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Binary
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 7/11/2011
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 8/1/2011
...
+ **Description of how the agency is ensuring that this AI use case is compliant with Information Quality Act guidelines and OMB Memorandum M-19-15, if applicable:**: The use case is not broadly disseminating information to the public, so i don't this this is applicable.
...
+ **Identification of the other demographic features explicitly utilized in the AI use case’s data/model(s), if any:**: Service-Rated Disability Conditions
...
+ **Link to publicly available source code for the AI use case, if available, in alignment with OMB Memorandum M-24-10’s section on sharing:**: https://h2o.ai/platform/ai-cloud/make/h2o/
+ **Whether the AI use case itself has an associated Authority to Operate (ATO), or is part of a system that has an ATO:**: Yes
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Data and Analytical Support for Healthcare (DASH) - #2515
...
+ **Explanation for whether the required IT infrastructure is identified and provisioned via a centralized process (such as a unified intake form) that enables product owners and developers to find the right development environment inside the agency:**: The design of DASH's intake is still to be determined because pending ATO is pending. The intake will occur at the facility level.
...
+ **:**: Other
+ **Explanation for whether communication regarding the provisioning of requested resources for the AI use case has been timely:**: Two requests to ARCHES for a cloud-based development space have not yielded any response from their intake team.
