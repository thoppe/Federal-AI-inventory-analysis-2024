## HHS-2024-0137
+ **Title of the AI use case:**: Autocorrect in MS Word
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: MS Word's autocorrect feature uses AI to suggest corrections, which improves the quality of written communications.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The output is autocorrected words or sentences in written documents.
