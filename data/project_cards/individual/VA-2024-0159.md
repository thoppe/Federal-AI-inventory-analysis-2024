## VA-2024-0159
+ **Title of the AI use case:**: Adobe Creative Cloud
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Develop nursing education presentations
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Used to make animations or to populate AI art.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: ASMS ID: 1279
