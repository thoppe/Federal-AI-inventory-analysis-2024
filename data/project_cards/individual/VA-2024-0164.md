## VA-2024-0164
+ **Title of the AI use case:**: Philips EPIQ Diagnostic Ultrasound System, Philips Affiniti Diagnostic Ultrasound System
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Described in FDA documentation for this device (https://www.accessdata.fda.gov/cdrh_docs/pdf21/K212704.pdf).
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 11/28/2022
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 11/28/2022
+ **Date when the AI use case was fully implemented and deployed into use:**: 11/28/2022
