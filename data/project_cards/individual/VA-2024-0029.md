## VA-2024-0029
+ **Title of the AI use case:**: Medallia SaaS - VSignals and ESignals
+ **Agency responsible for the AI use case:**: Department of Veterans Affairs
+ **Agency abbreviation:**: VA
+ **Specific organization(s) within the agency responsible for the AI use case:**: VEO: Veterans Experience Office
+ **The topic area that most closely aligns with the AI use case:**: Other
+ **The topic area that most closely aligns with the AI use case:**: Medallia is a customer experience management platform which can leverage AI (NLP) to review survey comments for actioning.
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: None of the above.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Medallia is a customer experience management platform which can leverage AI (NLP) to review survey comments for actioning.   VSignal survey comments (from Veterans) are processed by NLP to HELP determine if a Veteran is potentially in risk of crisis (related to homelessness and mental health).   If NLP flags a comment as a potential risk, a case is created and sent to the Crisis Line and Homeless Program for review and actioning.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: See above
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 6/1/2017
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: VA-22-00077985  this is the PIID for Call Order 25
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Data from VHA's corporate data warehouse
+ **Whether the data has sufficient documentation of its integrity, quality, and validity as a training set for a specific task:**: Documentation is complete: Documentation exists regarding the maintenance, composition, quality, and intended use of the training and evaluation data, as well as any statistical bias across model features and protected groups.
+ **Identification of the demographic features explicitly utilized in the AI use case’s data/model(s), if any:**: ["Race/Ethnicity","Sex/Gender","Age","Other"]
+ **Identification of the other demographic features explicitly utilized in the AI use case’s data/model(s), if any:**: rural - urban
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Medallia eCloud-e
...
+ **Explanation for whether the required IT infrastructure is identified and provisioned via a centralized process (such as a unified intake form) that enables product owners and developers to find the right development environment inside the agency:**: The infrastructure was available in 2017 so unclear if it went thru centralized intake
...
+ **Whether communication regarding the provisioning of requested resources for the AI use case has been timely:**: the use case utilizes SAAS cloud product so not sure if the question is applicable
+ **:**: Other
+ **Explanation for whether communication regarding the provisioning of requested resources for the AI use case has been timely:**: see above
