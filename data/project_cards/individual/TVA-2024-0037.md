## TVA-2024-0037
+ **Title of the AI use case:**: Threat Intelligence Feed
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Information Sharing; advanced technology and industry expertise to provide participants with near real-time delivery of relevant and actionable threat information of external network traffic.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 10/7/2020
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 10/7/2020
+ **Date when the AI use case was fully implemented and deployed into use:**: 10/7/2020
