## NSF-2024-0004
+ **Title of the AI use case:**: Adobe Photoshop
+ **Agency responsible for the AI use case:**: National Science Foundation
+ **Agency abbreviation:**: NSF
+ **Specific organization(s) within the agency responsible for the AI use case:**: OLPA
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: OLPA's Creative Services team will use Photoshop's AI-powered tools
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: to refine edits of photos and graphics, particularly the retouching of portraits.
