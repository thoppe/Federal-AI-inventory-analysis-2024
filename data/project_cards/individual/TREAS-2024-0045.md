## TREAS-2024-0045
+ **Title of the AI use case:**: M365 Copilot
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: An established group of participants across multiple business areas will test Artificial Intelligence-based features and functions available within the existing M365 applications using M365 Copilot.  The testing results will validate the security, benefits and capabilities that support the existing architectural boundaries of M365.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: User defined prompts
