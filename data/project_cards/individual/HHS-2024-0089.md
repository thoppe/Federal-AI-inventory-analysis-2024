## HHS-2024-0089
+ **Title of the AI use case:**: AI-assisted comment triaging tool
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Annual rulemaking-- the Physician Fee Schedule receives thousands of public comments and require assistance with reviewing and assigning the comments to the particular topics they address. 

Assists with workload for the PFS team
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: We use AI to assist in comment review, such as identifying form letters.
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 12/1/2021
