## FDIC-2024-0032
+ **Title of the AI use case:**: Goals and Workload Assumptions
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Summarize divisional efforts into a narrative taking into consideration staff numbers and competencies. Reduced time to receive answers based on data.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: A visualization of effectiveness of divisional projects and a recommendation on how to fill the gap on missing elements or competencies
