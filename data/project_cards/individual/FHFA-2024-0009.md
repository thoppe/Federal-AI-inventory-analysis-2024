## FHFA-2024-0009
+ **Title of the AI use case:**: R modules to support AI/ML
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Multiple R modules are installed to support AI and ML
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Multiple R modules are installed to support AI and ML
