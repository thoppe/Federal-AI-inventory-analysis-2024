## DOL-2024-0060
+ **Title of the AI use case:**: Tableau Creator (Desktop and Prep)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Enable analysts to connect, prepare, and visualize data.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: visual data dashboards, reports, and predictive models. Data Analysis
