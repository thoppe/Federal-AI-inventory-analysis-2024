## USDA-2024-0069
+ **Title of the AI use case:**: IPWG Application Survey Analysis
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 10/3/2024
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 10/3/2024
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Excel, Python, Google Cloud Platform
