## VA-2024-0008
+ **Title of the AI use case:**: Verkada Camera - OSSO
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Video search function inside a physical security camera solution.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Video and images from the AI searches inside the physical security camera solutions.
