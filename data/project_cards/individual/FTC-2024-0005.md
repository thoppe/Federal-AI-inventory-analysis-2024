## FTC-2024-0005
+ **Title of the AI use case:**: Graph Analytics
+ **Agency responsible for the AI use case:**: Federal Trade Commission
+ **Agency abbreviation:**: FTC
+ **Specific organization(s) within the agency responsible for the AI use case:**: BCP
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Assist Law Enforcement in identifying connections between complaints
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: node diagram
