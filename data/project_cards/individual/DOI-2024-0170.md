...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Purpose is to create machine learning models to predict crest movement of an embankment dam during a seismic event. The expected benefits are the creation of a screening-level tool to be used prior to large investments in field exploration, lab testing, and large scale modeling efforts.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 12/19/2016
