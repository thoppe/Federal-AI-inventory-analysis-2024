## DOI-2024-0146
+ **Title of the AI use case:**: Sediment Transport in Coastal Environments (funded by San Francisco Bay-Delta PES)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Machine learning based time-series imputation of oceanographic time-series
