## STATE-2024-0033
+ **Title of the AI use case:**: StateChat
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: StateChat is the Department's enterprise Generative AI-powered chatbot.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: StateChat is a chatbot, its outputs are textual in a chat interface.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: StateChat
