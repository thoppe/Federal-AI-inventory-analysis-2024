## USDA-2024-0081
+ **Title of the AI use case:**: Wildlife deterrent system
+ **Agency responsible for the AI use case:**: Department of Agriculture
+ **Agency abbreviation:**: USDA
+ **Specific organization(s) within the agency responsible for the AI use case:**: FS: Forest Service; Forest Service Research & Development
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The purpose of the AI device is to keep coyotes out of a fenced area by blocking their entry through a gap in the fence, while still allowing other wildlife to pass through. The benefits include making ecological research possible that couldn't be done otherwise, and saving time by reducing the need to watch camera footage and manually control the fence.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The model performs video object detection of a coyotes, and arms an electrical barrier to prevent passage of the coyote.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 8/26/2021
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 8/26/2021
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: GS-35F-0207T
