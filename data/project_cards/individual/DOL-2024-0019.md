## DOL-2024-0019
+ **Title of the AI use case:**: Generative AI Assistant
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Private and secure in-house solution to evaluate business use cases that can solve problems using Generative AI models and semantic search. Example use cases include text summarization, text analysis, and document comparisons.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The AI system provides recommendations.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 8/15/2023
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 8/15/2023
+ **Date when the AI use case was fully implemented and deployed into use:**: 8/16/2024
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Azure Open AI and AWS
