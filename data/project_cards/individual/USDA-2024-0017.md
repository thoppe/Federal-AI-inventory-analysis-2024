## USDA-2024-0017
+ **Title of the AI use case:**: Landscape Change Monitoring System (LCMS)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This project monitors large areas for changes in land cover and land use over time. The benefits include creating a consistent method for tracking changes in the landscape.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The model outputs predictions of vegetation gain, vegetation loss, land cover, and land uses.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 1/15/2016
...
+ **Description of how the agency is ensuring that this AI use case is compliant with Information Quality Act guidelines and OMB Memorandum M-19-15, if applicable:**: Providing International Organization for Standardization metadata and independent map validation results.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Google Cloud Platform contract
