## TVA-2024-0018
+ **Title of the AI use case:**: EnergyRightDERPortfolioEvaluation
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This app is primarily a visualization and export tool for the outputs of ES&P's system planning processes through which Enterprise Planning can obtain aggregations of ES&P forecasts and ES&P can gain insight into evaluation methodologies. It also contains a connection to the ES&P forecast aggregation engine for reporting purposes and stochastic simulation tools.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Report of ES&Ps aggregated forecasts
