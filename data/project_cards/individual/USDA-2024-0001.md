## USDA-2024-0001
+ **Title of the AI use case:**: Repair Spend
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The output of the model is a recommendation of which financial transactions should be identified as "repair" expenses.
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 6/9/2020
+ **Date when the AI use case was retired or began the process of retirement:**: 
+ **Whether the AI system involved in the use case was developed, or is expected to be developed, exclusively with contracting resources, in-house, or a combination of both:**: Developed with both contracting and in-house resources.
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: Developed by REE-Analytics within EDAPT to refresh Impala tables and visualized on the Tableau Server
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Enterprise Data Analytics Platform & Toolset (EDAPT, Impala, Tableau)
