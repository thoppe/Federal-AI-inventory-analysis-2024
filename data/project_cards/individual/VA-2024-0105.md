## VA-2024-0105
+ **Title of the AI use case:**: Densitas Density AI
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 36C10B22C0042
...
+ **Identification of the demographic features explicitly utilized in the AI use case’s data/model(s), if any:**: ["Age","Sex/Gender"]
