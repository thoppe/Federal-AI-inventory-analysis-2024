## DOL-2024-0057
+ **Title of the AI use case:**: Omni Page Ultimate 19
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Convert physical documents or image-based text into editable digital text.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Searchable and editable text from scanned or image-based documents. Object recognition OCR
