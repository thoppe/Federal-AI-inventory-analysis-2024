## HHS-2024-0132
+ **Title of the AI use case:**: Email Prioritization in Outlook
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The Outlook in Office365 suite can categorize incoming emails based on users' definitions, which can help users manage their inbox more efficiently. The output is categorized emails.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The output is categorized emails.
