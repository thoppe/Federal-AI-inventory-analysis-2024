## EPA-2024-0005
+ **Title of the AI use case:**: Generative AI for Study Evaluation and Document Chat
+ **Agency responsible for the AI use case:**: Environmental Protection Agency
+ **Agency abbreviation:**: EPA
+ **Specific organization(s) within the agency responsible for the AI use case:**: Office of Research and Development
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Reduce the time required to complete study evaluation and make it easier to find/recall information found in documents.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The outputs are generated text based upon a prompt. The text is intended to help the user answer questions about a document, specifically about the quality of the information reported.
