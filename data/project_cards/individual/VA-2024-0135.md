## VA-2024-0135
+ **Title of the AI use case:**: Synthetic Data Generation:  Experimenting with OpenSource, Third Party and GenAI
...
+ **The topic area that most closely aligns with the AI use case:**: Research:  creation of synthetic data for model training and development
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: None of the above.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Improve agility of research and operational dev
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Synthetic patient clinical and demographic data
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: CDW-ng is going to be used to train
...
+ **Identification of the other demographic features explicitly utilized in the AI use case’s data/model(s), if any:**: all of the above but none is saved.  only the synthetic data is saved.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: 2266
