## VA-2024-0108
+ **Title of the AI use case:**: Clinical Key | Elsevier
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: A search platform that clinicians can use when searching for current evidence- based medical practices.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Summary of medical literature or answers to medical questions based on a search prompt.
