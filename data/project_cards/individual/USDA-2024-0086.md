## USDA-2024-0086
+ **Title of the AI use case:**: Esri ArcGIS Pro Deep Learning Modules
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The purpose of this tool is to enhance scientific modeling and analysis, which will standardize Geographic Information System (GIS) workflows for modeling and analytics.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The tools will output image classifications.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: FS ACE
