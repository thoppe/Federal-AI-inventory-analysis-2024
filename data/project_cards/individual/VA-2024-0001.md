## VA-2024-0001
+ **Title of the AI use case:**: Evolv WDS - OSSO
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Using heat map technology to identify heat signature of known weapons.
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 36C25023P0332
