## USAID-2024-0021
+ **Title of the AI use case:**: Climate-based malaria forecast
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The climate-based model takes malaria confirmed cases and eco-climatic data to forecast the number of malaria cases/incidences up to 2 months ahead.
