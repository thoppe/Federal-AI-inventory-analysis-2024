...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 3/31/2015
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 3/31/2015
+ **Date when the AI use case was fully implemented and deployed into use:**: 3/31/2015
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: PO 816550
