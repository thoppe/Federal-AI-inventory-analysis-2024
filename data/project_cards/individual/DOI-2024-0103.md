## DOI-2024-0103
+ **Title of the AI use case:**: Zero shot segmentation to expedite Quaternary geologic mapping
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Geosciences and Environmental Change (GEC) Science Center (FEDMAP-funded): The construction of detailed geologic maps requires a lot of manual GIS data input to outline the extent of interpreted geologic features. We are working to extend and adapt the Segment Anything Model for identification of Quaternary geologic features in order to expedite the process of creating GIS data for geologic maps.
