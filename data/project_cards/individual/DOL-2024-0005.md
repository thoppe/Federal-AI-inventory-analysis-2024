## DOL-2024-0005
+ **Title of the AI use case:**: Claims Document Processing
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: To identify if physician's note contains causal language by training custom natural language processing models.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Document ranking by likely relevance and sentences highlighting of potentially causal language.
...
+ **Date when the AI use case was retired or began the process of retirement:**: 7/16/2024
