## HHS-2024-0131
+ **Title of the AI use case:**: Transcription in Zoom and Teams
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Meetings scheduled via Zoom or Teams can be transcribed live or from recorded meetings, which improves communication.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The output is a transcribed text from a live meeting or recorded meetings.
