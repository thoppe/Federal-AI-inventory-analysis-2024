## VA-2024-0044
+ **Title of the AI use case:**: Digizens
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Behavioral prediction model used to create clinical trials without the need for actual patients or patient information.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Output is behavioral analysis and predictions based on messaging and circumstances.
