## TVA-2024-0010
+ **Title of the AI use case:**: GMET
+ **Agency responsible for the AI use case:**: Tennessee Valley Authority
+ **Agency abbreviation:**: TVA
+ **Specific organization(s) within the agency responsible for the AI use case:**: Generation Projects & Fleet Strategy
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The Groundwater Modeling Evaluation Tool (GMET) is an R Shiny application that uses Phreeqc geochemical models and analysis to evaluate groundwater chemistry data at each of TVA’s CCR sites
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Geochemical reports on chemical makeup of groundwater data
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 2/6/2024
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Groundwater data from Equis
