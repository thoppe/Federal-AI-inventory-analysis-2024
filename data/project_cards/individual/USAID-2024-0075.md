## USAID-2024-0075
+ **Title of the AI use case:**: Crop pest identification and advisory
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: To more efficiently and precisely identify crop diseases and provide tailored recommendations on how to control the pest or disease
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The AI system generates tailored plant health advisory in the form of text in local languages
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 7/12/1905
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 7200AA21LE00005
