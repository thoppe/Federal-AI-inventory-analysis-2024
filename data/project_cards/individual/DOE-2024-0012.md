## DOE-2024-0012
+ **Title of the AI use case:**: ServiceNow Predictive Intelligence
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Provide better and more consistent classification of ticket data entered into ServiceNow
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Field classification data
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Existing ticket data is used to train the model with data and training servers stored within FedRAMP High data centers where ServiceNow is hosted
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: ServiceNow ATO
