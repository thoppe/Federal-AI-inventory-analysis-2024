## USAID-2024-0044
+ **Title of the AI use case:**: Identifying harmful social media content in Sinhala and Tamil
+ **Agency responsible for the AI use case:**: United States Agency for International Development
+ **Agency abbreviation:**: USAID
+ **Specific organization(s) within the agency responsible for the AI use case:**: USAID/Sri Lanka
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The activity will develop AI tools that can identify hate speech online, and to design various counter-measures, ranging from streamlined mechanisms to report such content to crafting counter-narratives that can mitigate the negative effects on targeted communities
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Reports on harmful content and content for counter narratives
