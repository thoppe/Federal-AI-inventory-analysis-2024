## DOI-2024-0068
+ **Title of the AI use case:**: Population and critical habitat modeling of overwintering monarch butterflies
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: High resolution land cover data, population abundance data, regional climate data
