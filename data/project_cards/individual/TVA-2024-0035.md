## TVA-2024-0035
+ **Title of the AI use case:**: Intrusion Detection Analysis
+ **Agency responsible for the AI use case:**: Tennessee Valley Authority
+ **Agency abbreviation:**: TVA
+ **Specific organization(s) within the agency responsible for the AI use case:**: Cybersecurity
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 9/11/2018
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 9/11/2018
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/11/2018
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: PO 4314465
