## USDA-2024-0040
+ **Title of the AI use case:**: Foodborne Illness Source Attribution
+ **Agency responsible for the AI use case:**: Department of Agriculture
+ **Agency abbreviation:**: USDA
+ **Specific organization(s) within the agency responsible for the AI use case:**: FSIS: Food Safety and Inspection Service
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 8/2/2021
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 2/1/2023
