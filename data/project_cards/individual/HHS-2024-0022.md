## HHS-2024-0022
+ **Title of the AI use case:**: Document Q&A Interface
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The SCCT consolidates a number of documents for every response that it monitors, and often analysts have questions about response context stored in those documents

Increase an analyst / user on Protect's knowledge of a specific response or MCM by allowing them to "ask questions" of associated / uploaded  SCCT media
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Large Language Models are used to query existing documents for answers based on a user's query
