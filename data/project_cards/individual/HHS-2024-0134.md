## HHS-2024-0134
+ **Title of the AI use case:**: Report Summarization by commercial GenAI platform
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Some GenAI platforms, such as ChatGPT and Google Gemini, can summarize documents with non-sensitive information.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The output is a summary of provided paragraphs or documents.
