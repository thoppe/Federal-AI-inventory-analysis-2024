## USAID-2024-0116
+ **Title of the AI use case:**: Labeling and classifying food security activities
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 6/25/2023
+ **Date when the AI use case was fully implemented and deployed into use:**: 4/1/2024
+ **Date when the AI use case was retired or began the process of retirement:**: 6/24/2024
+ **Whether the AI system involved in the use case was developed, or is expected to be developed, exclusively with contracting resources, in-house, or a combination of both:**: Developed with contracting resources.
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 47QRAD20DD1072 (TO - 7200AAN00006)
