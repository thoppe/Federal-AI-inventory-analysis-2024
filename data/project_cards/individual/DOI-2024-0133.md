## DOI-2024-0133
+ **Title of the AI use case:**: Everglades-Flux, Digital Surveys
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: We are creating a program that can automatically process Normalized Difference Vegetation Index images and come up with a true value of live vegetation. It will also gap fill missing data via AI/ML programs.
