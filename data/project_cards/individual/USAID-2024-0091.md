## USAID-2024-0091
+ **Title of the AI use case:**: ESDB/IDEA Series Classification
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Reduce labor hours involved in classifying new economic and social data indicators to categories in the ESDB/IDEA system by providing automatically suggested categories to data curation staff.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Suggested category assigments for social and economic indicator series.
