## FRB-2024-0033
+ **Title of the AI use case:**: Bank Exam Quality Control
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: A traditional machine learning NLP model of bank performance that utilizes information in news articles among various inputs
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Model outcomes are used as a component of quality control
