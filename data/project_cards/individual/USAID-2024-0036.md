## USAID-2024-0036
+ **Title of the AI use case:**: Wildlife identification using computer vision (Mbaza), DRC
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Mbaza was a machine learning program for identifying species in camera traps, which speeds up inventory of biodiversity surveys in a protected area of interest.
