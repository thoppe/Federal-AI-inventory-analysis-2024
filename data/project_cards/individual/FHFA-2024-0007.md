## FHFA-2024-0007
+ **Title of the AI use case:**: Analytics,, Search, Queries and LLM integration for data management on Oracle
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Oracle Enterprise 23AI has built in AI for predictive analytics, AI Vector search, Natural Language queries and integration with Large Language Models
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Oracle Enterprise 23AI has built in AI for predictive analytics, AI Vector search, Natural Language queries and integration with Large Language Models
