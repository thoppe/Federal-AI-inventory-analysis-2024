## FRB-2024-0004
+ **Title of the AI use case:**: PDF Optical Character Recognition (Images)
+ **Agency responsible for the AI use case:**: Board of Governors of the Federal Reserve System
+ **Agency abbreviation:**: FRB
+ **Specific organization(s) within the agency responsible for the AI use case:**: Division of Information Technology
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The intended purpose is to extract text from the image embedded in PDF file
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The AI system's output is the image details in text format for further analysis
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 7/17/2024
