## USAID-2024-0131
+ **Title of the AI use case:**: Combatting health misinformation in Yemen
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Combatting disinformation in conflict zones, The SecDev Foundation: SecDev Foundation collaborates with local partners in Yemen to empower conflict-affected communities in combating harmful health misinformation.They provide guidance through trusted local networks via various channels like emergency alerts, online campaigns, and radio bulletins to ensure accurate information reaches those in need. Funded through Humanitarian Grand Challenge
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Text
