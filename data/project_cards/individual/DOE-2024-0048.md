## DOE-2024-0048
+ **Title of the AI use case:**: Unleashing AI Transformer Models on FPGAs for Accelerating LHC and Particle Physics
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This effort focuses on Transformer models for representation learning on Field Programmable Gate Arrays
...
machine learning techniques offer superior alternatives.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: This AI system has two fold use cases, represnetation learning for LHC Trigger and multi-modal magnet quench detection algorithms.
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 10/1/2027
