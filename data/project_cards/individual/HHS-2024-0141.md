## HHS-2024-0141
+ **Title of the AI use case:**: News from commercial publisher such as Google News
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Major news publishers, such as Google News, send selective news based on users' preferences and recent visits.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The outputs from these news providers are more customized news feeds.
