## DOE-2024-0076
+ **Title of the AI use case:**: READS: Real-time Edge AI for Distributed Systems
...
+ **Link to publicly available source code for the AI use case, if available, in alignment with OMB Memorandum M-24-10’s section on sharing:**: https://github.com/fermilab-accelerator-ai/READS
