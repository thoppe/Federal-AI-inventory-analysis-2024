## FRB-2024-0008
+ **Title of the AI use case:**: Consumer Related Information Classification
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Classification of consumer related information to relevant regulations
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Assignment of one or more regulations to a consumer related information
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 3/16/2023
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 5/1/2023
+ **Date when the AI use case was fully implemented and deployed into use:**: 10/19/2023
