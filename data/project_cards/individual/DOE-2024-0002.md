## DOE-2024-0002
+ **Title of the AI use case:**: OpenText for Records Management (Email Auto-Classification)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Reduce time required to classify email records.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: OpenText will categorize each email message to an appropriate category.
...
+ **Date when the AI use case was retired or began the process of retirement:**: 6/1/2023
