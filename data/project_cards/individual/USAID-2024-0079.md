## USAID-2024-0079
+ **Title of the AI use case:**: Georgian speech-to-text transcription
+ **Agency responsible for the AI use case:**: United States Agency for International Development
+ **Agency abbreviation:**: USAID
+ **Specific organization(s) within the agency responsible for the AI use case:**: USAID/Georgia
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 9/22/2020
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 10/1/2021
+ **Date when the AI use case was fully implemented and deployed into use:**: 12/30/2022
+ **Date when the AI use case was retired or began the process of retirement:**: 
+ **Whether the AI system involved in the use case was developed, or is expected to be developed, exclusively with contracting resources, in-house, or a combination of both:**: Developed with contracting resources.
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 72011420CA00002
...
+ **Explanation for whether the AI use case made use of agency-wide infrastructure to quickly identify the rights datasets to begin model development:**: Program collected and labeled the dataset for purpose of training the system to learn to transcribe the speech in Georgian language; repository not currently maintained
...
+ **Whether communication regarding the provisioning of requested resources for the AI use case has been timely:**: Our partner organization has in-house computing resources for model training and development
+ **:**: Other
