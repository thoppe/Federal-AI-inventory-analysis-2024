## USAID-2024-0013
+ **Title of the AI use case:**: Chemonics International Inc.'s "Disinformation Monitoring and Sentiment Analysis"
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The Transition to New Sudan program, through a program subcontractor, uses AI technology to monitor social media posts for disinformation, and to monitor citizen sentiment analysis.
