## FRB-2024-0014
+ **Title of the AI use case:**: Graphic design improvements
+ **Agency responsible for the AI use case:**: Board of Governors of the Federal Reserve System
+ **Agency abbreviation:**: FRB
+ **Specific organization(s) within the agency responsible for the AI use case:**: Division of Board Members
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Enhances readability of presentations
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Updated slide layouts and visualizations
