## DOI-2024-0108
+ **Title of the AI use case:**: Mapping wildfire fuels in previously burned landscapes
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The goal is to understand how land management treatments affect the probability of reburning.
