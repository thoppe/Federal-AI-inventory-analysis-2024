## VA-2024-0107
+ **Title of the AI use case:**: Riverain ClearRead CT
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 36H79719D0016
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: VHA Centralized Lung CT CAD System #2219
