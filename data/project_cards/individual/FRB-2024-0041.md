## FRB-2024-0041
+ **Title of the AI use case:**: Threshold Monitoring
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Enhance monitoring on limits thresholds, faster collaboration
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: ​Tools serve analysts to enhance monitoring on limits thresholds and actuals
