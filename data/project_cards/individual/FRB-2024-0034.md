## FRB-2024-0034
+ **Title of the AI use case:**: Document Summarization Statistics
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Provide statistics about bank review letters based on the length of the letters and the frequency of common financial terms
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Statistics on letters contained in a PDF
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 12/22/2024
