## FRB-2024-0024
+ **Title of the AI use case:**: Sentiment Analysis of Earnings Transcripts
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Additional insight into sentiments related to topics in bank earnings calls
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The probability that text inputs are positive, negative, or neutral and classifies them as such
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 5/23/2023
