## NASA-2024-0002
+ **Title of the AI use case:**: NextGen Data Analytics: Letters of Agreement
+ **Agency responsible for the AI use case:**: National Aeronautics and Space Administration
+ **Agency abbreviation:**: NASA
+ **Specific organization(s) within the agency responsible for the AI use case:**: Ames Research Center
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Letter of agreement dataset from FAA
...
+ **Whether the AI use case itself has an associated Authority to Operate (ATO), or is part of a system that has an ATO:**: Operated in an approved enclave
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Checking
...
+ **Whether the AI use case promotes re-use of existing infrastructure to promote AI development:**: This project used external text mining capabilities
