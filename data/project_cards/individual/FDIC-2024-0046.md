## FDIC-2024-0046
+ **Title of the AI use case:**: Initial Deposit File Analysis
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Evaluate multiple data files in different formats to extract and normalize the inputs into a rationalized data set with the key elements needed for analysis by other functional areas within FDIC.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: List of accounts and assets with key data elements needed for insurance determination and asset valuation.
