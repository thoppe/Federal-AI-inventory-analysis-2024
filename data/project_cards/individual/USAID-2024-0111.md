## USAID-2024-0111
+ **Title of the AI use case:**: Generating SQL queries from natural language
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: SQL queries
