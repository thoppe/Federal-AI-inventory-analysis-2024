## DOI-2024-0052
+ **Title of the AI use case:**: Use of artificial intelligence tools for optimization and documentation for computer codes
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: For the USGS National Seismic Hazard Model and other earthquake hazards research, computer codes are needed that implement earthquake rupture forecasts and ground-motion models. This project uses ChatGPT to suggest optimizations and documentation for computer codes.
