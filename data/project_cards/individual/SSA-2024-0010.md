## SSA-2024-0010
+ **Title of the AI use case:**: Social Security Income Redetermination Model
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This AI use case identifies SSI overpayment cases that have highest expected overpayments for review. This use case contains excess overpayments by prioritizing technician review
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The system outputs numerical scores for individuals, comprised of likelihood and amount of overpayment.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 1/1/1995
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 1/1/1995
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/9/2024
...
+ **Identification of the demographic features explicitly utilized in the AI use case’s data/model(s), if any:**: Wages (Employment Status)
