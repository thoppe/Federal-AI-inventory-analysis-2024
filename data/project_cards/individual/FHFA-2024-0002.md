## FHFA-2024-0002
+ **Title of the AI use case:**: Neural Networks for FHFA Modeling Analytics Platform (FMAP)
+ **Agency responsible for the AI use case:**: Federal Housing Finance Agency
+ **Agency abbreviation:**: FHFA
+ **Specific organization(s) within the agency responsible for the AI use case:**: DHMG
