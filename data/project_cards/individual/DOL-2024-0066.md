## DOL-2024-0066
+ **Title of the AI use case:**: Speechify Text to Speech Voice Reader Chrome Extension 9
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Converts written text into natural-sounding speech.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Synthesized speech from written text in various voices and languages.
