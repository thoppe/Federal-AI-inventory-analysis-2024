## PT-2024-0004
+ **Title of the AI use case:**: Scheduling and managing social media posts using AI, including sentiment analysis
+ **Agency responsible for the AI use case:**: Presidio Trust
+ **Agency abbreviation:**: PT
+ **Specific organization(s) within the agency responsible for the AI use case:**: Information Technology
+ **The topic area that most closely aligns with the AI use case:**: Mission-Enabling
+ **The topic area that most closely aligns with the AI use case:**: 
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: Scheduling and managing social media posts using AI.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Improved communications, sentiment analysis, awareness and insights
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Reports on social media, recommended communications
