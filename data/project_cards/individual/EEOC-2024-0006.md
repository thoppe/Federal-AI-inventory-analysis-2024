## EEOC-2024-0006
+ **Title of the AI use case:**: Records Management
+ **Agency responsible for the AI use case:**: Equal Employment Opportunity Commission
+ **Agency abbreviation:**: EEOC
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Establish and maintain integrity of electronic data
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Generation. create digital documents or information that is organized, indexed, and accessed according to compliance standards.
