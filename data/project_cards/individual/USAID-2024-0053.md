## USAID-2024-0053
+ **Title of the AI use case:**: Virtual host for attendees of the Invest for Climate activity
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Present and interact with the attendees of the Invest for Climate Activity through a virtual host. Objectives include increasing the visibility of the project and facilitating interaction with the attendees.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Interactive "host" avatar
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 72051424D00003
