## FDIC-2024-0011
+ **Title of the AI use case:**: Student Outcome Projection
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Early intervention in the students academic growth providing the ability to support different learning styles and levels helping guide the right educational path forward personalizing learning

Streamlining learning and development for industry and office needs allowing employees reduction of tasks for onboarding and workforce planning and retention.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Prediction; Curriculum  mapping based on job specific tasks that results in each user and provide position specific training report.
