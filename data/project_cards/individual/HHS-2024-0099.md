## HHS-2024-0099
+ **Title of the AI use case:**: Agent/Broker Fraud Analysis
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Agent/Brokers (A/Bs) support the consumer enrollment and eligibility process. Because of this, they have learned the intricate details of the FFE for accessing applications, submitting eligibility determinations, and adding enrollments to their line of business, opening up the possibility of fraud. 

Improves the oversight and integrity of Marketplace Applications and Enrollments assisted by Agents and Brokers.  Helps CCIIO identify suspicious behaviors to refer to CPI.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Utilizes Machine Learning to identify suspicious behaviors of Agents and Brokers in the Marketplace
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: FFM
