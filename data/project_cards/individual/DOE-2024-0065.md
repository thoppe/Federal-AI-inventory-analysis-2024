## DOE-2024-0065
+ **Title of the AI use case:**: In-Situ Monitoring of Additively Manufactured Parts
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Identify print defects during the printing process.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Layerwise annotated images of defects in print bed that can be registered to post print analysis or trigger a fixing process or a full stop to save on material.
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: Government use license
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: ORNL Software
...
+ **How the agency is providing reasonable and timely notice regarding the use of AI, consistent with Section 5(c)(iv)(I) of OMB Memorandum M-24-10:**: Email , Other, if other please explain in next question.
+ **Whether the AI use case significantly influences the outcome of an adverse decision or action, consistent with Section 5(c)(v)(D) of OMB Memorandum M-24-10. Examples include the denial of benefits or deeming a transaction fraudulent:**: Email and regularly scheduled meetings.
...
+ **How the agency has consulted affected groups, including underserved communities, in the design, development, and use of the AI, consistent with Section 5(c)(v)(B) of OMB Memorandum M-24-10:**: N/A ORNL Software
