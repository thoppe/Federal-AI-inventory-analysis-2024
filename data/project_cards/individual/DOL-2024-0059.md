## DOL-2024-0059
+ **Title of the AI use case:**: Adobe Acrobat Professional Latest Version
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Streamlines document workflows.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Text-searchable PDFs, form-filled documents, and automatically structured files. Document management
