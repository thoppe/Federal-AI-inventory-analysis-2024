## DOI-2024-0067
+ **Title of the AI use case:**: NGWOS External R&D - Using advanced computing techniques for mobile monitoring platforms
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This project is designing a networking approach for underwater robotic sensor platforms so that they can work together without direct human intervention to adjust their monitoring operations to changing bathymetry and water conditions using artificial intelligence algorithms and underwater communications.
