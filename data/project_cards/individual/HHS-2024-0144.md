## HHS-2024-0144
+ **Title of the AI use case:**: Facial Recognition Unlock
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The Face ID feature in iPhones takes advantage of AI technology to securely unlock the phone.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: This feature allows the phone to be unlocked using facial recognition technology.
