## VA-2024-0103
+ **Title of the AI use case:**: ECG system software
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Commercially available software to assist with electrocardiogram interpretation
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Produces an ECG tracing and provides reading on ECG parameters
