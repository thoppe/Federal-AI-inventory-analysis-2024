## FDIC-2024-0010
+ **Title of the AI use case:**: Plagiarism Detection
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Detect and prevent cheating and dishonesty,  Promoting the FDIC's values including Fairness, Accountability, and Integrity.  Reduce the time manually inspecting for plagiarism.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Report with flagged suspected plagiarism, and sources
