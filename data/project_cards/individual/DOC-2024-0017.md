## DOC-2024-0017
+ **Title of the AI use case:**: DSD Python Code Translation
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The AI purpose for this effort is to assist the translation of SAS to Python code for the DSD data processing and supporting systems. The effort is in support of the Census mission to migration to enterprise-wide solutions and reducing dependency on costly proprietary software products.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The expected AI final system outputs are the translated Python code that replicates the SAS code. Comparison of the system outputs will be performed until the expected results are achieved.
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 10/28/2024
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 1333LC
...
+ **Identification of the other demographic features explicitly utilized in the AI use case’s data/model(s), if any:**: Pre-trained model for translating SAS code
