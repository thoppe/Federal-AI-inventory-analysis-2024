## FRB-2024-0010
+ **Title of the AI use case:**: Variable Optimization
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Iterate through alternative lag structures to identify the optimal one for forecasting call report metrics
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: A forecast for select call report metrics
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/28/2023
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Internal- FFIEC Call Report
