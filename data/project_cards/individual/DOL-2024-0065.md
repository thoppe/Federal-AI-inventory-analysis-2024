## DOL-2024-0065
+ **Title of the AI use case:**: Dragon Legal Individual (Speech Recognition)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Helps legal professionals transcribe spoken language into text.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Outputs transcriptions of legal dictations and spoken languages.
