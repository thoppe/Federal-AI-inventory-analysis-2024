## FDIC-2024-0005
+ **Title of the AI use case:**: AI Coding Assistant
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Enhance coding speed and accuracy by offering code suggestions in real time, writing unit tests, debugging code, explaining code, adding comments, and translating code across languages.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Code suggestions and suggested comments to explain code
