## HHS-2024-0222
+ **Title of the AI use case:**: JIT Automated Calculator (JAC)
...
NIGMS needs to know how much total support an investigator has to ensure that it is not funding Principal Investigators who are already adequately resourced. The tool can determine how much funding a Principal Investigators has been awarded.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The JIT Automated Calculator (JAC) uses NLP to parse Just-In-Time (JIT) Other Support forms and determine how much outside support PIs are receiving from sources other than the pending application.
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: All data come from the internal NIH IMPAC II database.
