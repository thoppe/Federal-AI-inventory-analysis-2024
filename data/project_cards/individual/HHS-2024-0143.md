## HHS-2024-0143
+ **Title of the AI use case:**: AI-Powered Travel Booking
+ **Agency responsible for the AI use case:**: Department of Health and Human Services
+ **Agency abbreviation:**: HHS
+ **Specific organization(s) within the agency responsible for the AI use case:**: HHS
+ **The topic area that most closely aligns with the AI use case:**: Mission-Enabling (internal agency support)
+ **The topic area that most closely aligns with the AI use case:**: 
+ **Whether the use case is implemented solely with the commercial-off-the-shelf or freely available AI products identified in Appendix B:**: Finding and booking travel accommodations using AI-powered platforms.
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Major travel booking websites, such as hotels.com, can provide booking options based on customers' preferences. Algorithms running in such services can optimize travel accommodations, which can save time and provide better deals.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The output is a list of travel accommodations for customers to choose from and make booking decisions.
