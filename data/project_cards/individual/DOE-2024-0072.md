## DOE-2024-0072
+ **Title of the AI use case:**: high level synthesis for machine learning (previously hls4ml)
...
+ **Link to publicly available source code for the AI use case, if available, in alignment with OMB Memorandum M-24-10’s section on sharing:**: https://github.com/fastmachinelearning/hls4ml
