## VA-2024-0037
+ **Title of the AI use case:**: Roche Digital Pathology
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: To aid pathologists in diagnosing pathology cases.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: It analyzes slide images to aid in diagnosing
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 12/15/2022
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: GS-07F-0446V
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Navify
