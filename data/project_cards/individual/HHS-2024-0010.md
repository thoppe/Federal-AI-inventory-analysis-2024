## HHS-2024-0010
+ **Title of the AI use case:**: Ask HR Policy
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: We are using LLMs to analyze the questions inputted by users. The AI model synthesizes the provided documentation sources and then summarizes and answers the users questions with cited sources.
