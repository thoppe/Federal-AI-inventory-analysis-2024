## DOI-2024-0123
+ **Title of the AI use case:**: Whole-lake indexing of round goby abundances with photographic catch data
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: USGS is responsible for monitoring abundances of prey fish across the entirety of the Great Lakes. This project utilizes autonomous vehicles and artificial intelligence to quantify abundances of one of the most abundant prey fishes in the Great Lakes, an invasive species called Round Goby. Robotic surveys of Roung Goby are carried out across three of the five Great Lakes each year. The work also characterizes surface geology, which influence round goby abundances.
