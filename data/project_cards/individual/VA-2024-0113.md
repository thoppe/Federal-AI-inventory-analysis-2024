## VA-2024-0113
+ **Title of the AI use case:**: XIDF-AWS801, Angio Workstation (Alphenix Workstation), V9.5
...
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Described in FDA documentation for this device (https://www.accessdata.fda.gov/cdrh_docs/pdf23/K232526.pdf).
