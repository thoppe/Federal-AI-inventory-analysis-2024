## TVA-2024-0032
+ **Title of the AI use case:**: Security Operations Enhancement
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Empowering SOC analysts with AI-enriched threat intelligence to understand landscapes, security posturing, and live attacks. Promoting the prioritization of event handling and investigative actions to identify and stop attacks by optimizing decision-making.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 9/29/2021
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 9/29/2021
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/29/2021
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: PO 7040159
