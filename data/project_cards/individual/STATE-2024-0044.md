## STATE-2024-0044
+ **Title of the AI use case:**: Text Similarity
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Identified different texts that were identical or nearly identical by calculating cosine similarity between each text. Texts were then grouped if they share high cosine similarity and then available for analysts to review further. This project is retired.
