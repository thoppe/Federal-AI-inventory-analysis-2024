## PBGC-2024-0001
+ **Title of the AI use case:**: Synthetic Data Generation
+ **Agency responsible for the AI use case:**: Pension Benefit Guaranty Corporation
+ **Agency abbreviation:**: PBGC
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: To create artificial data that mimics the features, structures, and statistical attributes of end user/pensioner data
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Unlike real data, which may contain sensitive or Personally Identifiable Information (PII), the synthetic data ensures data privacy, while enabling data analysis, research, and software testing
...
+ **Identification of the specific public-facing service that the AI use case supports:**: Using website resources to assist organizations with compliance
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: N/A.  Currently conducting market research to identify requirements for acquisition/implementation.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: N/a.  Acquisition has not been completed as of yet.
...
+ **How the agency is providing reasonable and timely notice regarding the use of AI, consistent with Section 5(c)(iv)(I) of OMB Memorandum M-24-10:**: Market researched still being conducted to determine configuration.
...
+ **Why the agency does not have an established fallback and escalation process:**: Market research is still being conducted.
