## HHS-2024-0142
+ **Title of the AI use case:**: Travel Route Optimization by Google Maps and Apple Maps
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Major commercial map service providers, such as Google Maps or Apple Maps, can automate and optimize travel routes based on algorithms and live traffic data, which can save time and provide optimal routes.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The output from these map services is an optimized travel route based on the user's preferences and live traffic data.
