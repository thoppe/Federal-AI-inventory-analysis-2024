## CFPB-2024-0002
+ **Title of the AI use case:**: Ask Complaints
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Support staff that analyze complaints by helping to scale production of quantiative data in response to questions posed by users. Cost avoidance.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Summary data points of cohorts of complaints.
