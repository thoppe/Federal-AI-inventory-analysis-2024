## HHS-2024-0153
+ **Title of the AI use case:**: Empirical evaluation of EHR-based signal detection approaches
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This supports Electronic Health Record (EHR) signal detection by extracting information using Natural Language Processing (NLP) and expanding the tree based scan statistic (TBSS) methods for EHR-based signal detection.


Extracts data to facilitate the identification of signals for outcomes, improving the manual identification of signals for outcomes derived from electronic health records.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The AI component in this study leverages an Natural Language Processing (NLP) approach to extract data from unstructured clinical notes.
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 75F40119D10037 - 75F40123F19010
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Claims-Electronic Health Record (EHR)
