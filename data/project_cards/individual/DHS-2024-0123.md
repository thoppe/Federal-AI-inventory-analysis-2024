## DHS-2024-0123
+ **Title of the AI use case:**: AdaptiveMFA
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Adaptive Multi-factor Authentication (AMFA) introduces additional intelligence into Identity flows by taking into account the authentication context data during the authentication. Using the data, DHS is able to adapt security and authentication policies to enhance the security to DHS systems.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The input includes: device, network, location, travel, IP, and external data from third parties and endpoint security integrations. The output are Risk ratings HIGH, MEDIUM, LOW for each authentication attempt which can be configigured to require stricted access comtrol policies.
...
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 3/30/2024
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 47QFRA24F0005
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: The system collects signal data during authentication to dynamically build behaviors of the user.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: The DHS Next Generation Authentication as a Service (DHSAuthPortal) System
