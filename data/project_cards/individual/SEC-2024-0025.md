## SEC-2024-0025
+ **Title of the AI use case:**: Developed Parsing Logic for Filings
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Help staff more efficiently search and analyze disclosure text contained in various filings.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: These efforts will help to search and analyze certain filings.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 20-Jan
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 23-May
+ **Date when the AI use case was fully implemented and deployed into use:**: 24-Jul
+ **Date when the AI use case was retired or began the process of retirement:**: 
+ **Whether the AI system involved in the use case was developed, or is expected to be developed, exclusively with contracting resources, in-house, or a combination of both:**: Developed with both contracting and in-house resources.
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 50310219D0008
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: AI Filing Parser
