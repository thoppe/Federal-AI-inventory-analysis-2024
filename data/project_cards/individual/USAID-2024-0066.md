## USAID-2024-0066
+ **Title of the AI use case:**: AI analysis of Moldova's media content and social media landscape
+ **Agency responsible for the AI use case:**: United States Agency for International Development
+ **Agency abbreviation:**: USAID
+ **Specific organization(s) within the agency responsible for the AI use case:**: USAID/Moldova
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This project utilizes AI to provide analysis of Moldova's media landscape, focusing on narrative framing techniques in both Romanian and Russian-language media and social media. The goal of this application is situational awareness and strategic communications planning, not content removal or blocking.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Monthly Reports
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: AID-117-A-17-00001
