## USAID-2024-0073
+ **Title of the AI use case:**: AI-powered portal for the Development Experience Clearinghouse
+ **Agency responsible for the AI use case:**: United States Agency for International Development
+ **Agency abbreviation:**: USAID
+ **Specific organization(s) within the agency responsible for the AI use case:**: USAID/Bureau for Conflict Prevention and Stabilization
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Making information in the Development Experience Clearinghouse easier to access and use
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Excel tables that feed into a Tableau dashboard with tables and other visualizations.
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 7200AA20D00013
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Documents from the Development Experience Clearinghouse
