## FRB-2024-0001
+ **Title of the AI use case:**: Economic Trend Modeling
+ **Agency responsible for the AI use case:**: Board of Governors of the Federal Reserve System
+ **Agency abbreviation:**: FRB
+ **Specific organization(s) within the agency responsible for the AI use case:**: Division of Monetary Affairs
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Additional data beyond traditional statistical models
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Multiple methods calculate the probability of a economic event in the next twelve months between 0 and 1 and are aggregated
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 3/1/2019
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 3/1/2019
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/23/2019
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Internal- Fixed Income
