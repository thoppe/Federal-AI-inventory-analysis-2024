## FTC-2024-0004
+ **Title of the AI use case:**: Word Cloud
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Uses natural language processing to visually explore complaints using word cloud and assist Law Enforcement to reduce the time required to analyze search results
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: word cloud
