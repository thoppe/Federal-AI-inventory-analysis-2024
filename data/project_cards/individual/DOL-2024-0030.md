## DOL-2024-0030
+ **Title of the AI use case:**: AI Assisted coding -Microsoft GitHub Copilot
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Automatically generate software code using Microsoft Copilot, this will reduce the time for generating code
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Automatically generate software code using Microsoft Copilot, this will reduce the time for generating code
