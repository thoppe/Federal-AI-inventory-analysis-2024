## NASA-2024-0013
+ **Title of the AI use case:**: Autonomous WAiting Room Evaluation (AWARE)
+ **Agency responsible for the AI use case:**: National Aeronautics and Space Administration
+ **Agency abbreviation:**: NASA
+ **Specific organization(s) within the agency responsible for the AI use case:**: Langley Research Center
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Using an existing security camera and YOLO Machine Learning model to detect and count number of people waiting for service at Langley's Badge & Pass Office. When a predetermined threshold of people is exceeded, automated texts and emails are sent to request additional help at the service counters.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Count of current customers in waiting area
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: AWARE
...
+ **Whether the AI use case promotes re-use of existing infrastructure to promote AI development:**: This project re-used prior work in identifying vehicles, objects or animals in a NASA environment
