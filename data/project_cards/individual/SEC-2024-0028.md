## SEC-2024-0028
+ **Title of the AI use case:**: Optical Character Recognition (OCR) for Records Analysis
+ **Agency responsible for the AI use case:**: Securities and Exchange Commission
+ **Agency abbreviation:**: SEC
+ **Specific organization(s) within the agency responsible for the AI use case:**: Division of Enforcement (ENF)
