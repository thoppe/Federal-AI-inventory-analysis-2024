## DOE-2024-0067
+ **Title of the AI use case:**: Elastic Stack Technology (ELK)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Enable intelligent media cataloging to assist with data discovery
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Intelligent collection content searching using ElasticSearch, Logstash, and Kibana
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: PO 4300182430 (renewed annually)
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Knowledge Preservation Management (KPM) Media
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Elastic Stack Software
...
+ **How the agency has consulted affected groups, including underserved communities, in the design, development, and use of the AI, consistent with Section 5(c)(v)(B) of OMB Memorandum M-24-10:**: Manual review by Human in the Loop resolves discrepancies
