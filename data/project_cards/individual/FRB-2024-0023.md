## FRB-2024-0023
+ **Title of the AI use case:**: Earnings Calls Analysis
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Analyzes company transcripts to identify key words, terms, and themes.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Suite of time series indicators showing evolution of word choice and topic classification
