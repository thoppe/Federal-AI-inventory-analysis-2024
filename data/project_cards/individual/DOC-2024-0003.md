## DOC-2024-0003
+ **Title of the AI use case:**: Sentinel One Purple AI
+ **Agency responsible for the AI use case:**: Department of Commerce
+ **Agency abbreviation:**: DOC
+ **Specific organization(s) within the agency responsible for the AI use case:**: BEA - Bureau of Economic Analysis
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Faster and more throughout incident response within the BEA cybersecurity program
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Log analysis
...
+ **Description of how the agency is ensuring that this AI use case is compliant with Information Quality Act guidelines and OMB Memorandum M-19-15, if applicable:**: Outputs from the tool will be reviewed by a human for accuracy and reliability; actions based on data provided by the AI will be manual, not automated.
