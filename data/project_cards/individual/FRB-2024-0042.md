## FRB-2024-0042
+ **Title of the AI use case:**: Supply and Demand Tool
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The tool is used to monitor and project resource and supply demand​ based on defined rule sets
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Resource monitor based on rule outcomes
