## DOI-2024-0060
+ **Title of the AI use case:**: Mapping sagebrush from drones to satellites
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Vegetation maps are critical tools for that are widely used in applications including habitat modeling, evaluating effectiveness of habitat restoration, and understanding the ecological implications of biological invasions. We are using machine learning and imagery from unmanned aerial vehicles (UAV), aircraft, and satellites to extend presence modeling to map fractional cover of sagebrush in the Dakotas, where accurate maps of sagebrush are needed to identify seasonal habitats of sage-grouse for the Bureau of Land Management.
