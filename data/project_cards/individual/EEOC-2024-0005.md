## EEOC-2024-0005
+ **Title of the AI use case:**: Legal Research & Discovery
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Improve quality, efficiency and/or access to services
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Generation. Relevant legal information to support enforcement and/or litigation activity
