## DOI-2024-0150
+ **Title of the AI use case:**: Machinine Learning based shoreline detection and sea ice dynamics using coastal cameras
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Supports basic data generation and QC/QA procedures, for large scale and short-term forecasting of shoreline trends and sea-ice dynamics in coastal environments
