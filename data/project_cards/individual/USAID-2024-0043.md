## USAID-2024-0043
+ **Title of the AI use case:**: Natural Language Processing to detect gender-based violence in Kenya
+ **Agency responsible for the AI use case:**: United States Agency for International Development
+ **Agency abbreviation:**: USAID
+ **Specific organization(s) within the agency responsible for the AI use case:**: USAID/Kenya and East Africa
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: This tool will detect patterns of technology-facilitated gender based violence (TFGBV), provide early identification of potential threats, and facilitate automatic and anonymous reporting.  The grantee is planning to employ machine learning algorithms for pattern detection, natural language processing (NLP), computer vision, and sentiment analysis.
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: 7200AA22RFA00002
