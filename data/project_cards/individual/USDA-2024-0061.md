## USDA-2024-0061
+ **Title of the AI use case:**: Equine Operations and Populations Dataset for the U.S.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 1/2/2023
...
+ **Identification of the Procurement Instrument Identifier(s) (PIID) of the contract(s) used for the AI use case:**: NADPRP / Farm Bill funds , cooperative agreement with Colorado State University
...
+ **Whether communication regarding the provisioning of requested resources for the AI use case has been timely:**: In process with MRP GIS Coordinator
+ **:**: Yes
