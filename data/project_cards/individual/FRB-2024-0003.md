## FRB-2024-0003
+ **Title of the AI use case:**: PDF Optical Character Recognition (Text)
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: The intended purpose is to extract and to decide the correct column name extracted from a report in PDF format
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: The list of the appropriate column names in text format
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 9/19/2021
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 9/22/2021
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/26/2024
