## TVA-2024-0007
+ **Title of the AI use case:**: Heliviewer
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Use of helicopter image data for survey and project insights
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Search engine of helicopter data to search through images, projects, flight patterns, etc.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 1/22/2022
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 1/22/2022
+ **Date when the AI use case was fully implemented and deployed into use:**: 7/20/2022
