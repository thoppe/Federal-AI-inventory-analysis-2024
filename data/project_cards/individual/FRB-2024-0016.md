## FRB-2024-0016
+ **Title of the AI use case:**: Manufacturer Sentiment Analysis
+ **Agency responsible for the AI use case:**: Board of Governors of the Federal Reserve System
+ **Agency abbreviation:**: FRB
+ **Specific organization(s) within the agency responsible for the AI use case:**: Division of Research and Statistics
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: To quantify survey responses related to forecasts of industrial production
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Time series measuring the sentiment of manufacturing via survey respondents
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 7/1/2022
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: External- Manufacturing
