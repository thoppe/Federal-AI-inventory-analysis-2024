## TVA-2024-0005
+ **Title of the AI use case:**: CR intelligent search
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Use NLP to search through CRs. Also tool to include pattern recognition and adding additional safety data to search for and do topic modeling on
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Search engine for looking through condition reports
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 6/15/2021
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 6/15/2021
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Python Dash
