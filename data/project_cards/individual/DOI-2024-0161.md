## DOI-2024-0161
+ **Title of the AI use case:**: Analytical Chemistry & Geologic Resources Identification from X-rays
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Determining chemistry and rock composition from X-ray-based analytical chemistry platforms
