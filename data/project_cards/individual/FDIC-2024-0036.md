## FDIC-2024-0036
+ **Title of the AI use case:**: FDIC Staffing Model
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Monitor retention rate, retirement planning, and knowledge retention and succession. Reduced time to receive answers, allowing folks to focus on more critical mission-driven work.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: A prediction on future staffing and recommendations on how to meet varied goal points
