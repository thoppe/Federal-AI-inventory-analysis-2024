## NSF-2024-0010
+ **Title of the AI use case:**: Data Access Alternatives: Artificial Intelligence Supported Interfaces
+ **Agency responsible for the AI use case:**: National Science Foundation
+ **Agency abbreviation:**: NSF
+ **Specific organization(s) within the agency responsible for the AI use case:**: SBE/NCSES
