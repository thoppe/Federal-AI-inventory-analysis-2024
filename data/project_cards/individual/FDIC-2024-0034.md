## FDIC-2024-0034
+ **Title of the AI use case:**: CFOO Travel Chatbot
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Compiling data from internal FDIC website and targeted documents to answer questions about FDIC travel. Makes information more readily available, searchable and readable.
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 8/10/2020
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 9/1/2020
+ **Date when the AI use case was fully implemented and deployed into use:**: 12/21/2021
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: CFOO (Chief Financial Officer Organization) Travel Chatbot use the FDIC Travel Policy data set for training. The data contains travel policy data elements. The travel policy data set is internally available for all the FDIC employees and contractors.
...
+ **Name of the system(s) associated with this AI use case, according to the ATO:**: Internal Chatbot Rasa (ICR) - Travel Chatbot
