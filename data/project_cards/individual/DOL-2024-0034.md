## DOL-2024-0034
+ **Title of the AI use case:**: CE Interview Imputations
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 10/20/2024
...
+ **Identification of the demographic features explicitly utilized in the AI use case’s data/model(s), if any:**: age, gender, family structure, race, urbanicity, education, primary sampling unit
