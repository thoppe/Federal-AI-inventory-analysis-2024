## DOL-2024-0069
+ **Title of the AI use case:**: Kurzweil
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Kurzweil 1000 makes printed or electronic text accessible to people with blindness and visual impairments, speaking text aloud in a variety of natural-sounding voices that can be modified to individual preferences.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: NLP: text to voice. Audio output from text input
