## USDA-2024-0046
+ **Title of the AI use case:**: GIS Invasive Tree Extraction for Field Level Users
...
+ **Date when the AI use case’s purpose and high-level requirements were first defined:**: 7/15/2019
+ **Date when the acquisition and/or development of the AI system associated with the use case first began:**: 7/15/2019
+ **Date when the AI use case was fully implemented and deployed into use:**: 9/30/2019
