## FRB-2024-0029
+ **Title of the AI use case:**: Decision Tree for Deposits Data
...
+ **Description of the AI’s intended purpose, including: (1) what problem the AI is used to solve and (2) the expected benefits and positive outcomes from the AI for an agency’s mission and/or the general public:**: Improved process efficiency and data quality.
+ **Description of what the AI system outputs, whether it’s a prediction, recommendation, decision, etc:**: Predetermined variables are calculated and then filtered to identify potential outliers in the current reporting period data
...
+ **Date when the AI use case was fully implemented and deployed into use:**: 8/29/2024
...
+ **General description of the data used for training, fine-tuning, and evaluation of the AI use case’s model(s). This should include a description of any data provided by the agency, whether the datasets are research datasets, publicly available, external, etc. and to the extent possible, sufficiently descriptive information from the vendor:**: Internal- H.6 Money Stock Measures
